...
--
-- Name: ancestry; Type: TYPE; Schema: public; Owner: -
--
...
--
-- Name: industry_hierarchy; Type: TYPE; Schema: public; Owner: -
--
...
--
-- Name: relationship_effective_weight; Type: TYPE; Schema: public; Owner: -
--

CREATE TYPE relationship_effective_weight AS (
	...
	leaf_node_flag integer,
	calculation_effective_weight integer,
	first_child_node integer
);


--
-- Name: relationship_info; Type: TYPE; Schema: public; Owner: -
--

CREATE TYPE relationship_info AS (
	relationship_id integer,
	network_id integer,
	from_element_id integer,
	to_element_id integer,
...
--
-- Name: seq_qname; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: qname; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: ancestor_get_elements(text, integer, integer, integer); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION ancestor_get_elements(local_name text, network_type integer, accession_id integer, level integer) RETURNS SETOF qname
    LANGUAGE plpgsql
    AS $$
DECLARE
               curRel qname;
...
BEGIN
               ...
               searchsql := 'SELECT from_q.*
                              ...
                              WHERE n.extended_link_qname_id = '||network_type||'
                                AND n.accession_id = '||accession_id||'
                                AND to_q.local_name = '''||local_name||'''';    

               FOR curRel IN EXECUTE(searchsql)
		
               LOOP		  					   
			 EXIT WHEN level = 0;
			 level = level - 1; 			 					                                                      
			 return query SELECT * FROM ancestor_get_elements(curRel.local_name, network_type, accession_id, level); 
				IF NOT FOUND THEN 
				level = level + 1;
			  	RETURN next curRel;
				END IF;
...
--
-- Name: ancestry_all(integer); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: ancestry_all(character varying); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: ancestry_compose_paths(integer, integer); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: seq_relationship; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: dts_relationship; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE dts_relationship (
    dts_relationship_id integer DEFAULT nextval('seq_relationship'::regclass) NOT NULL,
    dts_network_id integer NOT NULL,
    from_element_id integer,
    to_element_id integer,
    reln_order double precision,
    from_resource_id integer,
...
--
-- Name: COLUMN dts_relationship.from_resource_id; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN dts_relationship.from_resource_id IS 'Not used in base XBRL 2.1, but legal nonetheless';


--
-- Name: COLUMN dts_relationship.calculation_weight; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN dts_relationship.calculation_weight IS 'Obviously only for calculation relationships';


--
-- Name: ancestry_get_relationships(integer, integer); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION ancestry_get_relationships(network_id_arg integer, child_id integer) RETURNS SETOF dts_relationship
    LANGUAGE plpgsql
    AS $$
DECLARE
               curRel relationship;
...
--
-- Name: ancestry_in_accession(integer, integer); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: ancestry_in_accession(integer, character varying); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: ancestry_in_network(integer, integer); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: ancestry_in_network(integer, character varying); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: array_remove_value(anyarray, anyarray); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: base_taxonomy_name(integer); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: calendar_end_offset(date, date); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: calendar_period(date); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: calendar_period(date, date); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: calendar_period_full(date); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: seq_context; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: context; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--
...
CREATE TABLE context (
    ...
    context_xml_id character varying NOT NULL,
...
--
-- Name: calendar_period_full(context); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: calendar_period_full(date, date); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: calendar_period_size_diff_percentage(date, date); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: calendar_start_offset(date, date); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: calendar_year(date); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: calendar_year(date, date); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: compare_filings(integer, integer); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION compare_filings(a1_arg integer, a2_arg integer) RETURNS numeric
    LANGUAGE plpgsql
    AS $$
DECLARE
	diff_var	numeric;
...
BEGIN
	...
	INTO diff_var
	FROM (
		SELECT q.local_name, count(*)
		FROM accession_element ae
		JOIN element e
		  ON ae.element_id = e.element_id
		JOIN qname q
		  ON e.qname_id = q.qname_id
		WHERE ae.accession_id in (a1_arg, a2_arg)
		GROUP BY 1
		HAVING count(*) =1
	) x;

	SELECT count(DISTINCT q.local_name)
	INTO total_var
	FROM accession_element ae
	JOIN element e
	  ON ae.element_id = e.element_id
...
--
-- Name: delete_report(bigint); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION delete_report(in_report_id bigint) RETURNS integer
    LANGUAGE plpgsql
    AS $_$
DECLARE
  m_updated INTEGER;
  ...
  m_dts_id INTEGER;
  m_entry_dts_id INTEGER;
  m_unit_base_ids INTEGER[];
  m_row_count INTEGER;
  m_attribute_ids INTEGER[];

  m_text text;

BEGIN
    EXECUTE 'SET application_name TO ''delete_report(' || in_report_id || ')''';
    RAISE NOTICE 'delete_report(%)', in_report_id;
    --check if the report exists
    IF ((SELECT 1 FROM report WHERE report_id = in_report_id) IS NULL) THEN
	RAISE NOTICE 'Report does not exists, report_id = %', in_report_id;
	RETURN 0;
    END IF;

    SELECT entity_id INTO m_entity_id FROM report WHERE report_id = in_report_id;
    SELECT s.source_name, s.source_id 
    INTO m_source_name, m_source_id
    FROM source s
    JOIN report r
    ...
    GET DIAGNOSTICS m_row_count = ROW_COUNT;
    RAISE NOTICE 'Deleted % fact', m_row_count;

    -- unit
    WITH delete_unit_report AS (
	    DELETE FROM unit_report WHERE report_id = in_report_id
	    RETURNING unit_base_id
    )
    SELECT array_agg(unit_base_id)
    INTO m_unit_base_ids
    FROM delete_unit_report;

    RAISE NOTICE 'Deleted % unit_report', coalesce(array_length(m_unit_base_ids, 1), 0);

    /* Reduce the unit_base_ids to those that are no longer used (indicated by not being in the unit_report table) */
    SELECT array_agg(unit_base_id)
    INTO m_unit_base_ids
    FROM unnest(m_unit_base_ids) ub(unit_base_id)
    WHERE NOT EXISTS (SELECT 1 FROM unit_report ur WHERE ur.unit_base_id = ub.unit_base_id);

    IF array_length(m_unit_base_ids, 1) > 0 THEN
	RAISE NOTICE e'Deleting the following unit_base:\n%', (SELECT string_agg(unit_hash_string,e'\n') FROM unit_base WHERE unit_base_id = any(m_unit_base_ids));
    END IF;

    DELETE FROM unit_measure_base WHERE unit_base_id = any(m_unit_base_ids);
    GET DIAGNOSTICS m_row_count = ROW_COUNT;
    RAISE NOTICE 'Deleted % unit_measure_base', m_row_count;    

    DELETE FROM unit_base WHERE unit_base_id = any(m_unit_base_ids);
    GET DIAGNOSTICS m_row_count = ROW_COUNT;
    RAISE NOTICE 'Deleted % unit_base', m_row_count; 

    DELETE FROM context_dimension WHERE context_id IN 
            (SELECT context_id FROM context WHERE accession_id = in_report_id);
    GET DIAGNOSTICS m_row_count = ROW_COUNT;
    RAISE NOTICE 'Deleted % context_dimension', m_row_count;

    DELETE FROM context_dimension_explicit WHERE context_id IN 
            (SELECT context_id FROM context WHERE accession_id = in_report_id);
    GET DIAGNOSTICS m_row_count = ROW_COUNT;
    RAISE NOTICE 'Deleted % context_dimension_explicit', m_row_count;
     
    DELETE FROM context WHERE accession_id = in_report_id;
    GET DIAGNOSTICS m_row_count = ROW_COUNT;
    RAISE NOTICE 'Deleted % context', m_row_count;

    SELECT dts_id, entry_dts_id INTO m_dts_id, m_entry_dts_id FROM report WHERE report_id = in_report_id;

    WITH d AS (
     DELETE FROM report_document 
     WHERE report_id = in_report_id
     RETURNING document_id)
    SELECT array_agg(document_id) INTO m_doc_ids_working FROM d;

    m_doc_ids := m_doc_ids || m_doc_ids_working;
		    
    RAISE NOTICE 'Deleted % report_document', coalesce(array_length(m_doc_ids_working, 1), 0);

    DELETE FROM report_element WHERE report_id = in_report_id;
    GET DIAGNOSTICS m_row_count = ROW_COUNT;
    RAISE NOTICE 'Deleted % report_element', m_row_count;

    DELETE FROM report WHERE report_id = in_report_id;
    GET DIAGNOSTICS m_row_count = ROW_COUNT;
    RAISE NOTICE 'Deleted % report', m_row_count;
    
    /* 
    Check if the dts and the entry dts are named. If they are, they are never deleted.
    */
    FOR m_dts_id IN 
	SELECT dts_id 
	FROM dts 
	WHERE dts_id IN (m_dts_id, m_entry_dts_id) 
	  AND dts_name IS NULL
    LOOP
	--Only delete if there are no other reports that use the dts.
	IF (SELECT count(*) FROM report WHERE dts_id = m_dts_id OR entry_dts_id = m_dts_id) = 0 THEN
		DELETE FROM dts_relationship rel
			USING dts_network dn
			WHERE dn.dts_id = m_dts_id
			  AND rel.dts_network_id = dn.dts_network_id;
		GET DIAGNOSTICS m_row_count = ROW_COUNT;
		RAISE NOTICE 'Deleted % dts_relationship', m_row_count;	
		
		DELETE FROM dts_network
			WHERE dts_id = m_dts_id;
		GET DIAGNOSTICS m_row_count = ROW_COUNT;
		RAISE NOTICE 'Deleted % dts_network', m_row_count;
		...
		RAISE NOTICE 'Deleted % dts_document', coalesce(array_length(m_doc_ids_working, 1), 0);

		DELETE FROM dts_element
			WHERE dts_id = m_dts_id;
		GET DIAGNOSTICS m_row_count = ROW_COUNT;
		RAISE NOTICE 'Deleted % dts_element', m_row_count;
			
		DELETE FROM dts
			WHERE dts_id = m_dts_id;
		GET DIAGNOSTICS m_row_count = ROW_COUNT;
		RAISE NOTICE 'Deleted % dts', m_row_count;				
         END IF;			
    END LOOP; 

    /* Get document ids that are no longer used */
    SELECT array_agg(document_id)
    INTO m_doc_ids
    FROM unnest(m_doc_ids) d(document_id)
    WHERE NOT EXISTS (SELECT 1 FROM dts_document dd WHERE dd.document_id = d.document_id)
      AND NOT EXISTS (SELECT 1 FROM report_document rd WHERE rd.document_id = d.document_id);

    DELETE FROM reference_part WHERE resource_id in (SELECT resource_id FROM resource WHERE document_id = any(m_doc_ids));
    GET DIAGNOSTICS m_row_count = ROW_COUNT;
    RAISE NOTICE 'Deleted % reference_part', m_row_count;	

    DELETE FROM label_resource WHERE resource_id in (SELECT resource_id FROM resource WHERE document_id = any(m_doc_ids));
    GET DIAGNOSTICS m_row_count = ROW_COUNT;
    RAISE NOTICE 'Deleted % label_resource', m_row_count;

    DELETE FROM footnote_resource WHERE resource_id in (SELECT resource_id FROM resource WHERE document_id = any(m_doc_ids));
    GET DIAGNOSTICS m_row_count = ROW_COUNT;
    RAISE NOTICE 'Deleted % footnote_resource', m_row_count;
        
    DELETE FROM resource WHERE document_id = any(m_doc_ids);
    GET DIAGNOSTICS m_row_count = ROW_COUNT;
    RAISE NOTICE 'Deleted % resource', m_row_count;          

    WITH delete_eava AS (
	DELETE FROM element_attribute_value_association WHERE element_id in (SELECT element_id FROM element WHERE document_id = any(m_doc_ids)) RETURNING attribute_value_id
    )
    SELECT array_agg(attribute_value_id)
    INTO m_attribute_ids
    FROM delete_eava;

    RAISE NOTICE 'Deleted % element_attribute_value_association', coalesce(array_length(m_attribute_ids,1),0);

    DELETE FROM attribute_value av
    WHERE av.attribute_value_id = any(m_attribute_ids)
      AND NOT EXISTS (SELECT 1 FROM element_attribute_value_association eava WHERE eava.attribute_value_id = av.attribute_value_id);
    GET DIAGNOSTICS m_row_count = ROW_COUNT;
    RAISE NOTICE 'Deleted % attribute_value', m_row_count;

    DELETE FROM element WHERE document_id = any(m_doc_ids);
    GET DIAGNOSTICS m_row_count = ROW_COUNT;
    RAISE NOTICE 'Deleted % element', m_row_count;

    DELETE FROM custom_role_used_on WHERE custom_role_type_id in (SELECT custom_role_type_id FROM custom_role_type WHERE document_id = any(m_doc_ids));
    GET DIAGNOSTICS m_row_count = ROW_COUNT;
    RAISE NOTICE 'Deleted % custom_role_used_on', m_row_count;
    
    DELETE FROM custom_role_type WHERE document_id = any(m_doc_ids);
    GET DIAGNOSTICS m_row_count = ROW_COUNT;
    RAISE NOTICE 'Deleted % custom_role_type', m_row_count;
    
    DELETE FROM custom_arcrole_used_on WHERE custom_arcrole_type_id in (SELECT custom_arcrole_type_id FROM custom_arcrole_type WHERE document_id = any(m_doc_ids));
    GET DIAGNOSTICS m_row_count = ROW_COUNT;
    RAISE NOTICE 'Deleted % custom_arcrole_used_on', m_row_count;
    
    DELETE FROM custom_arcrole_type WHERE document_id = any(m_doc_ids);
    GET DIAGNOSTICS m_row_count = ROW_COUNT;
    RAISE NOTICE 'Deleted % custom_arcrole_type', m_row_count;    

    DELETE FROM document_structure WHERE parent_document_id = any(m_doc_ids);
    GET DIAGNOSTICS m_row_count = ROW_COUNT;
    RAISE NOTICE 'Deleted % document_structure', m_row_count; 
    
    DELETE FROM document WHERE document_id = any(m_doc_ids);
    GET DIAGNOSTICS m_row_count = ROW_COUNT;
    RAISE NOTICE 'Deleted % document', m_row_count; 

    /* Handle entities */
    DELETE FROM entity_source es
    WHERE entity_id = m_entity_id
      AND NOT EXISTS (
	SELECT 1
	FROM report r
	WHERE r.entity_id = es.entity_id
	  AND r.source_id = es.source_id
	  AND r.source_id = m_source_id);
    GET DIAGNOSTICS m_row_count = ROW_COUNT;
    RAISE NOTICE 'Deleted % entity_source', m_row_count; 
    
    --Rebuild entity_name_history
    DELETE FROM entity_name_history WHERE entity_id = m_entity_id;
    GET DIAGNOSTICS m_row_count = ROW_COUNT;
    RAISE NOTICE 'Deleted % entity_name_history', m_row_count;     

    IF (SELECT count(*) FROM report WHERE entity_id = m_entity_id) > 0 THEN
	    /* rebuild the entity_name_history */
	    INSERT INTO entity_name_history (entity_id, accession_id, entity_name)
	    SELECT entity_id, report_id, entity_name
	    FROM (
		SELECT entity_id, report_id, coalesce(trim(both entity_name),'') as entity_name, TRIM(BOTH COALESCE(lag(entity_name) OVER (ORDER BY accepted_timestamp, report_id),'*#@!')) as next_entity_name
		FROM report
		WHERE entity_id = m_entity_id
		ORDER BY accepted_timestamp, report_id
		) AS x
	    WHERE entity_name <> next_entity_name;
	    GET DIAGNOSTICS m_row_count = ROW_COUNT;
	    RAISE NOTICE 'Insert back % entity_name_history', m_row_count;  
	    ...
	    GET DIAGNOSTICS m_row_count = ROW_COUNT;
	    RAISE NOTICE 'Deleted % entity', m_row_count; 	      
    ...
    ELSE
	    /* There are no reports left for this entity */
	    DELETE FROM entity WHERE entity_id = m_entity_id;
	    GET DIAGNOSTICS m_row_count = ROW_COUNT;
	    RAISE NOTICE 'Deleted % entity', m_row_count;   	    
...
--
-- Name: descendant_get_eff_network_relationships(integer, integer, integer, integer); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION descendant_get_eff_network_relationships(parent_id integer, network_type integer, network_id integer, weight integer) RETURNS SETOF relationship_effective_weight
    LANGUAGE plpgsql
    AS $$
DECLARE
               curRel relationship_effective_weight;
               searchsql text;
             
BEGIN
		
               searchsql := 'SELECT rel.*
			  ...
			  return query 
				SELECT * FROM descendant_get_eff_network_relationships(curRel.to_element_id, network_type, network_id, (weight * curRel.calculation_weight)::integer); 
				 IF NOT FOUND THEN 			    
				    curRel.leaf_node_flag = 0;
				    curRel.calculation_effective_weight = weight * curRel.calculation_weight;	
				    --curRel.first_child_node  = 0;		
			  	RETURN next curRel;
				END IF;
				  IF FOUND THEN 				  
				  curRel.leaf_node_flag = 1;
				  curRel.calculation_effective_weight = weight * curRel.calculation_weight;	
				  --curRel.first_child_node  = 1	;
...
--
-- Name: descendant_get_elements(text, integer, integer, integer); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION descendant_get_elements(local_name text, network_type integer, accession_id integer, level integer) RETURNS SETOF qname
    LANGUAGE plpgsql
    AS $$
DECLARE
               curRel qname;
...
BEGIN
               ...
               searchsql := 'SELECT to_q.*
                              ...
                              WHERE n.extended_link_qname_id = '||network_type||'
                                AND n.accession_id = '||accession_id||'
                                AND from_q.local_name = '''||local_name||'''';    
			 ...
			 EXIT WHEN level = 0;
			 level = level - 1; 			 					                                                      
			 return query SELECT * FROM descendant_get_elements(curRel.local_name, network_type, accession_id, level); 
				IF NOT FOUND THEN 
				level = level + 1;
			  	RETURN next curRel;
				END IF;
...
--
-- Name: descendant_get_network_relationships(integer, integer, integer); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION descendant_get_network_relationships(parent_id integer, network_type integer, network_id integer) RETURNS SETOF relationship_info
    LANGUAGE plpgsql
    AS $$
DECLARE
               curRel relationship_info;
               searchsql text;
...
BEGIN
			   ...
			   --return next  curRel;					                                                      
			  return query 
				SELECT * FROM descendant_get_network_relationships(curRel.to_element_id, network_type, network_id); 
				 IF NOT FOUND THEN 
				curRel.leaf_node_flag = 0;
			  	RETURN next curRel;
				END IF;
...
--
-- Name: descendant_get_network_relationships(text, integer, integer); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION descendant_get_network_relationships(parent_id text, network_type integer, network_id integer) RETURNS SETOF relationship_info
    LANGUAGE plpgsql
    AS $$
DECLARE
               curRel relationship_info;
...
BEGIN
               ...
               searchsql := 'SELECT rel.*
					...
					JOIN relationship rel
					  ON n.network_id = rel.network_id
					JOIN element e
						ON rel.from_element_id = e.element_id
					JOIN qname q 
						ON e.qname_id = q.qname_id
					WHERE  n.extended_link_qname_id = '||network_type||'
					AND n.network_id = '||network_id||'
					AND q.local_name = '''||parent_id||''''; 
...
--
-- Name: descendant_get_relationships(integer, integer); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION descendant_get_relationships(parent_id integer, network_type integer) RETURNS SETOF relationship_info
    LANGUAGE plpgsql
    AS $$
DECLARE
               curRel relationship_info;
...
BEGIN
               ...
               LOOP		  					   
			   return next  curRel;					                                                      
			  return query SELECT * FROM descendant_get_network_relationships(curRel.to_element_id, network_type, curRel.network_id);                   
               END LOOP;
               return;
END
$$;
...
--
-- Name: descendant_get_relationships(integer, integer, integer); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION descendant_get_relationships(parent_id integer, network_type integer, accession_id integer) RETURNS SETOF relationship_info
    LANGUAGE plpgsql
    AS $$
DECLARE
               curRel relationship_info;
...
BEGIN
			  ...
			  return query SELECT * FROM descendant_get_network_relationships(curRel.to_element_id, network_type, curRel.network_id);  
			  IF NOT FOUND THEN 
				curRel.to_resource_id = 0;
				curRel.leaf_node_flag = 0;
			  	RETURN next curRel;
				END IF;
			  IF FOUND THEN 
			  curRel.to_resource_id = 1;
			  curRel.leaf_node_flag = 0;
			  RETURN next curRel; 
			  END IF;
...
--
-- Name: descendant_get_relationships(text, integer, integer); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION descendant_get_relationships(parent_id text, network_type integer, accession_id integer) RETURNS SETOF relationship_info
    LANGUAGE plpgsql
    AS $$
DECLARE
               curRel relationship_info;
...
--
-- Name: descendant_get_relationships_limit(integer, integer, integer, integer); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION descendant_get_relationships_limit(network_id_arg integer, parent_id integer, network_type integer, level integer) RETURNS SETOF dts_relationship
    LANGUAGE plpgsql
    AS $$
DECLARE
               curRel relationship;
...
BEGIN
               ...
               searchsql := 'SELECT rel.*, n.*
                              FROM   network n
                                ...
                                JOIN qname to_q
                                  ON to_e.qname_id = to_q.qname_id
                              WHERE n.network_id = '||network_id_arg||'
                                --AND n.arc_qname_id = '||network_type||'
                                AND from_e.element_id = '||parent_id;
			 ...
			 return query SELECT * FROM descendant_get_relationships_limit(network_id_arg, curRel.to_element_id, network_type, level);                   
               END LOOP;
               return;
END
$$;
...
--
-- Name: descendant_get_uri_eff_relationships(text, integer, integer, text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION descendant_get_uri_eff_relationships(parent_id text, network_type integer, accession_id integer, extended_link_role_uri text) RETURNS SETOF relationship_effective_weight
    LANGUAGE plpgsql
    AS $$
DECLARE
               curRel relationship_effective_weight;
...
BEGIN
               ...
               searchsql := 'SELECT rel.*
					...
					JOIN qname q 
				      ...
				      WHERE  n.extended_link_qname_id = '||network_type||'
					AND n.accession_id = '||accession_id||'
					AND n.extended_link_role_uri_id = (select uri_id from uri where uri = '''||extended_link_role_uri||''')
					AND q.local_name = '''||parent_id||'''';  
		weight = 1;
			  ...
			  return query SELECT * FROM descendant_get_eff_network_relationships(curRel.to_element_id, network_type, curRel.network_id, (weight * curRel.calculation_weight)::integer);  
...
--
-- Name: descendant_get_uri_relationships(text, integer, integer, text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION descendant_get_uri_relationships(parent_id text, network_type integer, accession_id integer, extended_link_role_uri text) RETURNS SETOF relationship_info
    LANGUAGE plpgsql
    AS $$
DECLARE
               curRel relationship_info;
...
--
-- Name: document_navigate(integer, integer, integer, integer[]); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION document_navigate(doc_id_arg integer, tree_order_arg integer, level_arg integer, processed_ids integer[]) RETURNS TABLE(tree_order integer, level integer, document_id integer, starts_loop boolean)
    LANGUAGE plpgsql
    AS $$
DECLARE
    next_doc_id int;
...
--
-- Name: document_tree(integer); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION document_tree(document_id_arg integer) RETURNS TABLE(tree_order integer, level integer, document_id integer, starts_loop boolean)
    LANGUAGE sql
    AS $$
    SELECT document_navigate(document_id_arg, 0, 0, ARRAY[]::int[])
$$;


--
-- Name: document_type(integer); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: dts_tree(integer); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION dts_tree(dts_id_arg integer) RETURNS TABLE(tree_order integer, level integer, document_id integer, starts_loop boolean)
    LANGUAGE plpgsql
    AS $$
DECLARE
    root_doc_id    int;
...
--
-- Name: fiscal_period(date, date); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: fiscal_period(date, integer); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: fiscal_period(date, date, date); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: fiscal_period(date, date, integer); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: fiscal_period(date, integer, integer); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: fiscal_period(date, date, integer, integer); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: fiscal_year(date, date); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: fiscal_year(date, integer); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: fiscal_year(date, integer, integer); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: fiscal_year_beginning_of_year_adjustment(integer, integer); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: fiscal_year_end(integer); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: fiscal_year_end(character varying); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: fiscal_year_end_adjusted(integer); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: get_entity_id_by_element(integer); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: get_facts(character varying, boolean, integer); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION get_facts(primary_name_arg character varying, only_unqualified_arg boolean DEFAULT false, return_limit_arg integer DEFAULT 10) RETURNS TABLE(fact_id integer, entry_url character varying, entity_name character varying, filing_date date, document_type character varying, base_taxonomy_name character varying, effective_value numeric, uom character varying, fiscal_year integer, fiscal_period character varying, dimensions character varying[])
    LANGUAGE plpgsql
    AS $_$
DECLARE
	row record;
	return_limit_var	varchar;
BEGIN
	IF return_limit_arg Is NULL THEN
		return_limit_var := '';
	ELSE
		return_limit_var := 'LIMIT ' || return_limit_arg;
	END IF;
	
	IF only_unqualified_arg THEN

		RETURN QUERY EXECUTE 
			'SELECT f.fact_id, a.entry_url::varchar, a.entity_name, a.filing_date, document_type(a.accession_id), base_taxonomy_name(a.accession_id)
				,f.effective_value, uom(f.unit_id), ca.fiscal_year, ca.fiscal_period, NULL::varchar[]
			FROM accession a
			JOIN fact f
			...
			JOIN qname q
			  ON e.qname_id = q.qname_id
			WHERE q.local_name = $1
			  AND NOT c.specifies_dimensions ' || return_limit_var 
			USING primary_name_arg;
	
	ELSE
		RETURN QUERY EXECUTE 
			'SELECT f.fact_id, a.entry_url::varchar, a.entity_name, a.filing_date, document_type(a.accession_id), base_taxonomy_name(a.accession_id)
				,f.effective_value, uom(f.unit_id), ca.fiscal_year, ca.fiscal_period, list_dimensional_qualifications(c.context_id)
			FROM accession a
			JOIN fact f
			  ON a.accession_id = f.accession_id
			JOIN context c
			...
			JOIN qname q
			  ON e.qname_id = q.qname_id
			WHERE q.local_name = $1 ' || return_limit_var
			USING primary_name_arg;
	END IF;
	RETURN;
END
...
--
-- Name: get_facts(character varying, character varying, character varying, integer); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION get_facts(primary_name_arg character varying, axis_name_arg character varying, member_name_arg character varying, return_limit_arg integer DEFAULT 10) RETURNS TABLE(fact_id integer, entry_url character varying, entity_name character varying, filing_date date, document_type character varying, base_taxonomy_name character varying, effective_value numeric, uom character varying, fiscal_year integer, fiscal_period character varying, dimensions character varying[])
    LANGUAGE plpgsql
    AS $_$
DECLARE
	row record;
...
BEGIN
	...
	RETURN QUERY EXECUTE 
		'SELECT f.fact_id, a.entry_url::varchar, a.entity_name, a.filing_date, document_type(a.accession_id), base_taxonomy_name(a.accession_id)
			,f.effective_value, uom(f.unit_id), ca.fiscal_year, ca.fiscal_period, list_dimensional_qualifications(ca.context_id)
		FROM accession a
		JOIN fact f
		  ON a.accession_id = f.accession_id
		JOIN context_aug ca
		  ON f.context_id = ca.context_id
		JOIN context_dimension_explicit cd
		  ON f.context_id = cd.context_id
		JOIN element e
		  ON f.element_id = e.element_id
		JOIN qname q
		  ON e.qname_id = q.qname_id
		...
		WHERE q.local_name = $1
		  AND qa.local_name = $2
		  AND qm.local_name = $3
		  AND base_taxonomy_name(a.accession_id) = ''US GAAP 2013'' ' || return_limit_var
		USING primary_name_arg, axis_name_arg, member_name_arg;
	RETURN;
END
$_$;
...
--
-- Name: get_simple_fact_by_accession(character varying, character varying, integer, anyelement); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION get_simple_fact_by_accession(prefix_arg character varying, local_name_arg character varying, accession_id_arg integer, return_type anyelement) RETURNS anyelement
    LANGUAGE plpgsql
    AS $$
DECLARE
	prefix_var character varying;
	result_row RECORD;
BEGIN
	SELECT f.effective_value, f.fact_value
	INTO result_row
	FROM accession a
	JOIN fact f
	  ON a.accession_id = f.accession_id
	...
	JOIN context c
	  ON f.context_id = c.context_id
	WHERE NOT c.specifies_dimensions
	  AND a.accession_id = accession_id_arg
	  AND q.local_name = local_name_arg
	  AND CASE WHEN prefix_arg = 'extension' THEN n.prefix IS NULL
	           WHEN prefix_arg IS NULL THEN n.prefix = 'us-gaap'
	           ELSE n.prefix = prefix_arg
	      END 
	ORDER BY f.fact_id
	LIMIT 1;

	IF result_row.effective_value IS NULL THEN
		RETURN result_row.fact_value;
	ELSE
		RETURN result_row.effective_value;
	END IF;
END	      
$$;
...
--
-- Name: hash_calendar_fact_string(integer); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION hash_calendar_fact_string(fact_id_arg integer) RETURNS character varying
    LANGUAGE sql
    AS $$
SELECT     CASE WHEN f.calendar_period is Null OR strpos(f.calendar_period,'-') > 0 THEN null ELSE
    concat_ws('|'
        --Fact concept
        ...
        --Period
        ,f.calendar_period || f.calendar_year
        --Unit
...
--
-- Name: hash_context(integer); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: hash_context(context); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: hash_context_string(integer); Type: FUNCTION; Schema: public; Owner: -
--
...
SELECT concat_ws('|'
        ...
        ,en.authority_scheme || '|' || en.entity_code
        --Period
        ,CASE WHEN c.period_start IS NULL AND c.period_end IS NULL AND c.period_instant IS NULL THEN
            'F'
              WHEN c.period_start IS NULL THEN
            to_char(c.period_instant,'YYYYMMDD')
              ELSE
            to_char(c.period_start,'YYYYMMDD') || '-' || to_char(c.period_end,'YYYYMMDD') END
        --Dimensions
        ,string_agg(
            CASE WHEN dn.is_base THEN 'b' || dn.prefix || ':' || dq.local_name
                  ELSE 'e' || en.authority_scheme || '|' || en.entity_code || ':' || dq.local_name END || '=' ||
    ...
    GROUP BY c.context_id, en.authority_scheme, en.entity_code, c.period_start, c.period_end, c.period_instant
$$;


--
-- Name: hash_dimensional_qualifications(integer); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: hash_dimensional_qualifications_for_fact(integer); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION hash_dimensional_qualifications_for_fact(fact_id_arg integer) RETURNS character varying
    LANGUAGE sql
    AS $$
    SELECT hash_dimensional_qualifications(f.context_id)
    FROM fact f
    WHERE f.fact_id = fact_id_arg
$$;
...
--
-- Name: hash_fact(integer); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: hash_fact(character varying); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: hold_xucc_for_accession(integer); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: is_base(character varying); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: is_extended_fact(integer); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: list_dimensional_qualifications(integer); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: list_dimensional_qualifications2(integer); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION list_dimensional_qualifications2(context_id_arg integer) RETURNS character varying[]
    LANGUAGE plpgsql
    AS $$
DECLARE
cd_record RECORD;
...
BEGIN
	...
	LOOP
	dimension_row :=  ARRAY[ARRAY[cd_record.dim_namespace, cd_record.dim_local_name, cd_record.mem_namespace, cd_record.mem_local_name]];
	dimension_list := dimension_list || dimension_row;
	END LOOP;
	return dimension_list;
END
...
--
-- Name: list_dimensional_qualifications_for_fact(integer); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: list_dimensional_qualifications_for_fact2(integer); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION list_dimensional_qualifications_for_fact2(fact_id_arg integer) RETURNS character varying[]
    LANGUAGE plpgsql
    AS $$
DECLARE
context_id_var integer;
...
--
-- Name: list_dimensional_qualifications_for_fact2_json(integer); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION list_dimensional_qualifications_for_fact2_json(fact_id_arg integer) RETURNS json
    LANGUAGE plpgsql
    AS $$
DECLARE
context_id_var integer;
...
BEGIN
	...
	dimension_row := json_build_object('dimension_namespace', cd_record.dim_namespace, 
					   'dimension_local_name', cd_record.dim_local_name,
					   'member_namespace', cd_record.mem_namespace,
					   'member_local_name', cd_record.mem_local_name);
	
	dimension_list := dimension_list || dimension_row;
	END LOOP;
	return array_to_json(dimension_list);
END
$$;


--
-- Name: list_dimensional_qualifications_string(integer); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION list_dimensional_qualifications_string(context_id_arg integer) RETURNS character varying
    LANGUAGE plpgsql
    AS $$
DECLARE
cd_record RECORD;
...
BEGIN
	...
	LOOP
	dimension_row :=  cd_record.dim_namespace || '|' || cd_record.dim_local_name || '|' || COALESCE(cd_record.mem_namespace,'') || '|' || cd_record.mem_local_name || '|';
	dimension_list := dimension_list || dimension_row;
	END LOOP;
	return dimension_list;
END
...
--
-- Name: list_dimensional_qualifications_string2(integer); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION list_dimensional_qualifications_string2(context_id_arg integer) RETURNS character varying
    LANGUAGE plpgsql
    AS $$
DECLARE
	cd_record RECORD;
	dimension_list varchar;
	dimension_row  varchar;
	first_iteration boolean default true;
...
BEGIN
	...
	LOOP
		dimension_row :=  newline || '{' ||cd_record.dim_namespace || '}' || cd_record.dim_local_name || '=' || COALESCE('{' || cd_record.mem_namespace || '}', '') || cd_record.mem_local_name;
		dimension_list := dimension_list || dimension_row;
...
--
-- Name: make_tsquery(character varying); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: normalize_space(text); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: overlap_interval(date, date, date, date); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: print_industry_hierarchy(character varying, integer); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: set_creation_software_short(); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: set_document_type(); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: set_extension_count(); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: taxonomy_type(character varying); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: ticker(integer); Type: FUNCTION; Schema: public; Owner: -
--
...
WHERE document_uri ~* E'http://www.sec.gov/.*/[^_]*\\.xsd$'
AND   r.report_id = (
	      SELECT max(report_id)
	      FROM report
	      WHERE entity_id = $1
	      AND   (properties ->> 'filing_date')::date = (
			     SELECT MAX((properties ->> 'filing_date')::date)
			     FROM report
			     WHERE entity_id = $1)
)
$_$;
...
--
-- Name: uom(integer); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION uom(unit_id_arg integer) RETURNS character varying
    LANGUAGE sql
    AS $$
SELECT CASE WHEN unit_id_arg IS NULL THEN NULL 
       ELSE
       COALESCE(
            (
            select string_agg( q1.local_name, ' * '::varchar) as uom
...
--
-- Name: update_all_period_index(); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: update_all_restatement_index(); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: update_calendar_index(bytea); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION update_calendar_index(hash_string bytea) RETURNS integer
    LANGUAGE sql
    AS $$
    WITH results AS (
        UPDATE fact f
        ...
        WHERE f.fact_id = x.fact_id
          AND f.calendar_ultimus_index != x.rn
        RETURNING 1
    )
...
--
-- Name: update_specifies_dimensions(integer); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: update_ultimus_index(bytea); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION update_ultimus_index(hash_string bytea) RETURNS integer
    LANGUAGE sql
    AS $$
    WITH results AS (
        UPDATE fact f
...
--
-- Name: year_to_char(double precision); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: year_to_char(integer); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: year_to_char(numeric); Type: FUNCTION; Schema: public; Owner: -
--
...
CREATE TABLE report (
    ...
    reporting_period_end_date timestamp without time zone,
...
--
-- Name: accession; Type: VIEW; Schema: public; Owner: -
--
...
CREATE VIEW accession AS
 SELECT r.report_id AS accession_id,
    ...
    r.entity_name,
    r.creation_software,
    NULL::character varying AS creation_software_short,
  ...
  WHERE (s.source_name = 'SEC'::text);


--
-- Name: dts_document; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE dts_document (
    dts_document_id integer NOT NULL,
    dts_id integer NOT NULL,
...
--
-- Name: report_document; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: accession_document_association; Type: VIEW; Schema: public; Owner: -
--
...
CREATE VIEW accession_document_association AS
 SELECT rd.report_document_id AS accession_document_association_id,
   ...
   FROM (report_document rd
     JOIN report r ON ((rd.report_id = r.report_id)))
UNION ALL
 SELECT dd.dts_document_id AS accession_document_association_id,
    r.report_id AS accession_id,
    dd.document_id
   FROM (report r
     JOIN dts_document dd ON ((r.dts_id = dd.dts_id)));


--
-- Name: dts_element; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE dts_element (
    dts_element_id integer NOT NULL,
    dts_id integer NOT NULL,
...
--
-- Name: report_element; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: accession_element; Type: VIEW; Schema: public; Owner: -
--

CREATE VIEW accession_element AS
 SELECT DISTINCT ON (x.report_id, x.element_id) x.accession_element_id,
   ...
   FROM ( SELECT 1 AS sort_order,
        ...
        UNION ALL
         SELECT 2 AS sort_order,
            ...
            NULL::integer
           FROM (report r
             JOIN dts_element de ON ((r.dts_id = de.dts_id)))
          WHERE de.in_relationship) x
  ORDER BY x.report_id, x.element_id, x.sort_order;


--
-- Name: accession_industry_div; Type: VIEW; Schema: public; Owner: -
--
 ...
 SELECT accession.accession_id,
   ...
   FROM accession,
    ( SELECT accession_1.standard_industrial_classification,
            ...
            foo.sic_l1,
                CASE
                    WHEN ((foo.sic_l1 < (10)::numeric) AND (foo.sic_l1 >= (1)::numeric)) THEN '1'::text
                    WHEN ((foo.sic_l1 < (15)::numeric) AND (foo.sic_l1 >= (10)::numeric)) THEN '2'::text
                    WHEN ((foo.sic_l1 < (18)::numeric) AND (foo.sic_l1 >= (15)::numeric)) THEN '3'::text
                    WHEN ((foo.sic_l1 < (22)::numeric) AND (foo.sic_l1 >= (20)::numeric)) THEN '4'::text
                    WHEN ((foo.sic_l1 < (40)::numeric) AND (foo.sic_l1 >= (22)::numeric)) THEN '5'::text
                    WHEN ((foo.sic_l1 < (50)::numeric) AND (foo.sic_l1 >= (40)::numeric)) THEN '6'::text
                    WHEN ((foo.sic_l1 < (52)::numeric) AND (foo.sic_l1 >= (50)::numeric)) THEN '7'::text
                    WHEN ((foo.sic_l1 < (60)::numeric) AND (foo.sic_l1 >= (52)::numeric)) THEN '8'::text
                    WHEN ((foo.sic_l1 < (68)::numeric) AND (foo.sic_l1 >= (60)::numeric)) THEN '9'::text
                    WHEN ((foo.sic_l1 < (89)::numeric) AND (foo.sic_l1 >= (70)::numeric)) THEN '10 '::text
                    WHEN (foo.sic_l1 < (1)::numeric) THEN '11'::text
                    WHEN (foo.sic_l1 >= (89)::numeric) THEN '12'::text
                    ELSE NULL::text
                END AS division_no
           FROM accession accession_1,
            ( SELECT to_number(to_char((accession_2.standard_industrial_classification / 100), '99'::text), '99'::text) AS sic_l1,
                    accession_2.accession_id
                   FROM accession accession_2) foo
          WHERE (accession_1.accession_id = foo.accession_id)) foo2
  WHERE (foo2.accession_id = accession.accession_id);


--
-- Name: accession_timestamp; Type: VIEW; Schema: public; Owner: -
--
...
--
-- Name: seq_attribute_value; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: attribute_value; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE attribute_value (
    attribute_value_id integer DEFAULT nextval('seq_attribute_value'::regclass) NOT NULL,
    qname_id integer NOT NULL,
    text_value character varying NOT NULL
);


--
-- Name: base_namespace_base_namespace_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE base_namespace_base_namespace_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: base_namespace; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE base_namespace (
    base_namespace_id integer DEFAULT nextval('base_namespace_base_namespace_id_seq'::regclass) NOT NULL,
    preface character varying NOT NULL,
    prefix_expression character varying,
    source_id integer NOT NULL
);


--
-- Name: seq_custom_role_type; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: custom_role_type; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: seq_document; Type: SEQUENCE; Schema: public; Owner: -
--
...
CREATE TABLE document (
    ...
    document_uri character varying NOT NULL,
    document_loaded boolean DEFAULT true NOT NULL,
    content text,
    document_type character varying,
    target_namespace character varying
);


--
-- Name: dts_network; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: seq_element; Type: SEQUENCE; Schema: public; Owner: -
--
...
CREATE TABLE element (
    ...
    is_tuple boolean NOT NULL
);


--
-- Name: COLUMN element.balance_id; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN element.period_type_id; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN entity.entity_code; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN entity.authority_scheme; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: network; Type: VIEW; Schema: public; Owner: -
--
...
CREATE VIEW network AS
 SELECT dn.dts_network_id AS network_id,
    ...
    dn.description
   FROM (report r
     JOIN dts_network dn ON (((dn.dts_id = r.dts_id) OR (dn.dts_id = r.entry_dts_id))));


--
-- Name: relationship; Type: VIEW; Schema: public; Owner: -
--
...
--
-- Name: seq_uri; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: uri; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: calculation_view; Type: VIEW; Schema: public; Owner: -
--
...
CREATE VIEW calculation_view AS
 SELECT entity.entity_id,
   ...
   FROM ((((((((((((((((relationship
     JOIN network ON ((network.network_id = relationship.network_id)))
     JOIN accession ON ((network.accession_id = accession.accession_id)))
     JOIN accession_document_association from_ada ON ((from_ada.accession_id = accession.accession_id)))
     JOIN accession_document_association to_ada ON ((to_ada.accession_id = accession.accession_id)))
     JOIN document to_document ON ((to_ada.document_id = to_document.document_id)))
     JOIN qname elqname ON ((network.extended_link_qname_id = elqname.qname_id)))
     JOIN uri elruri ON ((network.extended_link_role_uri_id = elruri.uri_id)))
     JOIN qname arcqname ON ((network.arc_qname_id = arcqname.qname_id)))
     JOIN uri arcroleuri ON ((network.arcrole_uri_id = arcroleuri.uri_id)))
     JOIN element from_element ON (((from_element.document_id = from_ada.document_id) AND (relationship.from_element_id = from_element.element_id))))
     JOIN qname from_qname ON ((from_element.qname_id = from_qname.qname_id)))
     JOIN element to_element ON (((to_element.document_id = to_ada.document_id) AND (relationship.to_element_id = to_element.element_id))))
     JOIN qname to_qname ON ((to_element.qname_id = to_qname.qname_id)))
     JOIN entity ON ((accession.entity_id = entity.entity_id)))
     JOIN accession_document_association cr_ada ON ((cr_ada.accession_id = accession.accession_id)))
     JOIN custom_role_type ON (((custom_role_type.uri_id = network.extended_link_role_uri_id) AND (custom_role_type.document_id = cr_ada.document_id))))
  WHERE ((arcqname.local_name)::text = 'calculationArc'::text)
  ORDER BY entity.entity_id, accession.accession_id, custom_role_type.definition, relationship.tree_sequence;
...
--
-- Name: context_aug; Type: VIEW; Schema: public; Owner: -
--

CREATE VIEW context_aug AS
...
--
-- Name: seq_context_dimension; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: context_dimension; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--
...
CREATE TABLE context_dimension (
	...
	dimension_local_name text,
	member_namespace text,
	member_local_name text
);


--
-- Name: context_dimension_explicit; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE context_dimension_explicit (
...
--
-- Name: context_dimension_explicit_plus; Type: MATERIALIZED VIEW; Schema: public; Owner: -; Tablespace: 
--

CREATE MATERIALIZED VIEW context_dimension_explicit_plus AS
 SELECT cde.context_dimension_id,
    cde.context_id,
    cde.dimension_qname_id,
    cde.member_qname_id,
    cde.typed_qname_id,
    cde.is_default,
    cde.is_segment,
    cde.typed_text_content,
    dq.namespace AS dimension_namespace,
    dq.local_name AS dimension_local_name,
    mq.namespace AS member_namespace,
    mq.local_name AS member_local_name
   FROM ((context_dimension_explicit cde
     JOIN qname dq ON ((cde.dimension_qname_id = dq.qname_id)))
     LEFT JOIN qname mq ON ((cde.member_qname_id = mq.qname_id)))
  WITH NO DATA;


--
-- Name: seq_custom_arcrole_type; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: custom_arcrole_type; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: COLUMN custom_arcrole_type.cycles_allowed; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: seq_custom_arcrole_used_on; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: custom_arcrole_used_on; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: seq_custom_role_used_on; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: custom_role_used_on; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: definition_view; Type: VIEW; Schema: public; Owner: -
--
...
CREATE VIEW definition_view AS
 SELECT entity.entity_id,
   ...
   FROM ((((((((((((((((relationship
     ...
     JOIN accession_document_association cr_ada ON ((cr_ada.accession_id = accession.accession_id)))
     JOIN custom_role_type ON (((custom_role_type.uri_id = network.extended_link_role_uri_id) AND (custom_role_type.document_id = cr_ada.document_id))))
  WHERE (((arcqname.local_name)::text <> 'calculationArc'::text) AND ((arcqname.local_name)::text <> 'presentationArc'::text))
  ORDER BY entity.entity_id, accession.accession_id, custom_role_type.definition, relationship.tree_sequence;


--
-- Name: document_structure; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE document_structure (
    document_structure_id integer NOT NULL,
...
--
-- Name: document_structure_document_structure_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE document_structure_document_structure_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: document_structure_document_structure_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE document_structure_document_structure_id_seq OWNED BY document_structure.document_structure_id;


--
-- Name: dts; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE dts (
    dts_id integer NOT NULL,
    dts_hash bytea NOT NULL,
    dts_name character varying
);


--
-- Name: dts_document_dts_document_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE dts_document_dts_document_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: dts_document_dts_document_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE dts_document_dts_document_id_seq OWNED BY dts_document.dts_document_id;


--
-- Name: dts_dts_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE dts_dts_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: dts_dts_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE dts_dts_id_seq OWNED BY dts.dts_id;


--
-- Name: dts_element_dts_element_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE dts_element_dts_element_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: dts_element_dts_element_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE dts_element_dts_element_id_seq OWNED BY dts_element.dts_element_id;


--
-- Name: dts_network_dts_network_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE dts_network_dts_network_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: dts_network_dts_network_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE dts_network_dts_network_id_seq OWNED BY dts_network.dts_network_id;


--
-- Name: seq_element_attribute_value_association; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: element_attribute_value_association; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: seq_label_resource; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: label_resource; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE label_resource (
    resource_id integer DEFAULT nextval('seq_label_resource'::regclass) NOT NULL,
    label text NOT NULL,
    xml_lang character varying
);


--
-- Name: seq_resource; Type: SEQUENCE; Schema: public; Owner: -
--
...
CREATE TABLE resource (
    ...
    xml_location character varying
);


--
-- Name: element_labels_view; Type: VIEW; Schema: public; Owner: -
--
...
CREATE VIEW element_labels_view AS
 SELECT entity.entity_id,
   ...
   FROM ((((((((((relationship
     JOIN network ON ((network.network_id = relationship.network_id)))
     JOIN accession ON ((network.accession_id = accession.accession_id)))
     JOIN accession_document_association acc_doc_assoc ON ((acc_doc_assoc.accession_id = accession.accession_id)))
     JOIN document ON ((acc_doc_assoc.document_id = document.document_id)))
     JOIN element ON ((relationship.from_element_id = element.element_id)))
     JOIN entity ON ((accession.entity_id = entity.entity_id)))
     JOIN qname element_qname ON ((element_qname.qname_id = element.qname_id)))
     JOIN label_resource ON ((relationship.to_resource_id = label_resource.resource_id)))
     JOIN resource ON ((relationship.to_resource_id = resource.resource_id)))
     JOIN uri ON ((uri.uri_id = resource.role_uri_id)))
  ORDER BY entity.entity_id, accession.accession_id, element_qname.local_name;


--
-- Name: entity_identifier; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE entity_identifier (
    entity_identifier_id integer NOT NULL,
    entity_id integer NOT NULL,
...
--
-- Name: entity_identifier_entity_identifier_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE entity_identifier_entity_identifier_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: entity_identifier_entity_identifier_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE entity_identifier_entity_identifier_id_seq OWNED BY entity_identifier.entity_identifier_id;


--
-- Name: entity_name_history_entity_name_history_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: entity_name_history; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: entity_source; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: entity_source_entity_source_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE entity_source_entity_source_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: entity_source_entity_source_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE entity_source_entity_source_id_seq OWNED BY entity_source.entity_source_id;


--
-- Name: seq_enumeration_arcrole_cycles_allowed; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: enumeration_arcrole_cycles_allowed; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: seq_enumeration_element_balance; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: enumeration_element_balance; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: seq_enumeration_element_period_type; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: enumeration_element_period_type; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: seq_enumeration_unit_measure_location; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: enumeration_unit_measure_location; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: seq_fact; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: fact; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: fact_aug; Type: VIEW; Schema: public; Owner: -
--

CREATE VIEW fact_aug AS
 SELECT fact.fact_id,
    fact.fact_hash,
    fact.ultimus_index,
    NULL::integer AS current_index,
    fact.calendar_hash,
...
--
-- Name: fact_dei_view; Type: VIEW; Schema: public; Owner: -
--
    ...
    (context
     LEFT JOIN ( SELECT axis_qname.local_name AS axis,
           ...
           FROM context_dimension,
            qname axis_qname,
            qname member_qname
          WHERE (((context_dimension.is_segment = true) AND (axis_qname.qname_id = context_dimension.dimension_qname_id)) AND (member_qname.qname_id = context_dimension.member_qname_id))) dimension ON ((context.context_id = dimension.context_id)))
  WHERE ((((((qname.qname_id = element.qname_id) AND ("substring"((qname.namespace)::text, '[^0-9]*'::text) = 'http://xbrl.us/dei/'::text)) AND (element.element_id = fact.element_id)) AND (fact.accession_id = accession.accession_id)) AND (accession.entity_id = entity.entity_id)) AND (fact.context_id = context.context_id));


--
-- Name: unit_report; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE unit_report (
    unit_report_id integer NOT NULL,
    report_id integer NOT NULL,
...
--
-- Name: unit; Type: VIEW; Schema: public; Owner: -
--
...
--
-- Name: unit_measure_base; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE unit_measure_base (
    unit_measure_base_id integer NOT NULL,
    unit_base_id integer NOT NULL,
    qname_id integer NOT NULL,
...
--
-- Name: COLUMN unit_measure_base.location_id; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: unit_measure; Type: VIEW; Schema: public; Owner: -
--
...
CREATE VIEW unit_measure AS
 SELECT umb.unit_measure_base_id AS unit_measure_id,
   ...
   FROM (unit_measure_base umb
     JOIN unit_report ur ON ((umb.unit_base_id = ur.unit_base_id)));


--
-- Name: fact_element_view; Type: VIEW; Schema: public; Owner: -
--
...
CREATE VIEW fact_element_view AS
 SELECT entity.entity_id,
   ...
   FROM (((((((((((((((((fact
     JOIN accession ON ((fact.accession_id = accession.accession_id)))
     JOIN entity ON ((accession.entity_id = entity.entity_id)))
     JOIN element ON ((fact.element_id = element.element_id)))
     JOIN qname elementqname ON ((element.qname_id = elementqname.qname_id)))
     JOIN qname elementbasedatatypeqname ON ((element.xbrl_base_datatype_qname_id = elementbasedatatypeqname.qname_id)))
     JOIN qname elementdatatypeqname ON ((element.datatype_qname_id = elementdatatypeqname.qname_id)))
     JOIN qname elementsubgroupqname ON ((element.substitution_group_qname_id = elementsubgroupqname.qname_id)))
     JOIN context ON ((fact.context_id = context.context_id)))
     JOIN enumeration_element_balance ON ((enumeration_element_balance.enumeration_element_balance_id = element.balance_id)))
     JOIN enumeration_element_period_type ON ((enumeration_element_period_type.enumeration_element_period_type_id = element.period_type_id)))
     LEFT JOIN context_dimension ON ((context_dimension.context_id = context.context_id)))
     LEFT JOIN qname contextdimensionqname ON ((context_dimension.dimension_qname_id = contextdimensionqname.qname_id)))
     LEFT JOIN qname contextdimensionmemberqname ON ((context_dimension.member_qname_id = contextdimensionmemberqname.qname_id)))
     LEFT JOIN unit ON ((fact.unit_id = unit.unit_id)))
     LEFT JOIN unit_measure ON ((unit_measure.unit_id = unit.unit_id)))
     LEFT JOIN qname unitmeasureqname ON ((unit_measure.qname_id = unitmeasureqname.qname_id)))
     LEFT JOIN enumeration_unit_measure_location ON ((enumeration_unit_measure_location.enumeration_unit_measure_location_id = unit_measure.location_id)))
  ORDER BY entity.entity_id, accession.accession_id, context.context_id, elementqname.local_name;


--
-- Name: footnote_resource_resource_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE footnote_resource_resource_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: footnote_resource; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE footnote_resource (
    resource_id integer DEFAULT nextval('footnote_resource_resource_id_seq'::regclass) NOT NULL,
...
--
-- Name: industry_industry_id_seq1; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: industry; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: industry_level_industry_level_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: industry_level; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: industry_structure_industry_structure_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: industry_structure; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: namespace_namespace_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: COLUMN namespace.is_base; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: namespace_source; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE namespace_source (
    namespace_source_id integer NOT NULL,
...
--
-- Name: namespace_source_namespace_source_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE namespace_source_namespace_source_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: namespace_source_namespace_source_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE namespace_source_namespace_source_id_seq OWNED BY namespace_source.namespace_source_id;


--
-- Name: period_fact_element_view; Type: VIEW; Schema: public; Owner: -
--
...
CREATE VIEW period_fact_element_view AS
 SELECT en.entity_name,
    en.entity_code,
    qc.local_name,
    qa.local_name AS axis,
    qm.local_name AS member,
    f.effective_value AS amount,
    (ca.fiscal_year)::double precision AS year,
    a.filing_date,
    a.restatement_index,
    a.accession_id,
    qc.namespace,
    f.fact_id,
    (ca.fiscal_period)::text AS period,
    uom(f.unit_id) AS uom
   FROM (((((((((fact f
     JOIN accession a ON ((f.accession_id = a.accession_id)))
     JOIN element ec ON ((f.element_id = ec.element_id)))
     JOIN qname qc ON ((ec.qname_id = qc.qname_id)))
     JOIN entity en ON ((en.entity_id = a.entity_id)))
     JOIN context c ON ((f.context_id = c.context_id)))
     JOIN context_aug ca ON ((c.context_id = ca.context_id)))
     LEFT JOIN context_dimension cd ON (((cd.context_id = c.context_id) AND (cd.is_segment = true))))
     LEFT JOIN qname qa ON ((qa.qname_id = cd.dimension_qname_id)))
     LEFT JOIN qname qm ON ((qm.qname_id = cd.member_qname_id)));


--
-- Name: presentation_view; Type: VIEW; Schema: public; Owner: -
--
...
CREATE VIEW presentation_view AS
 SELECT entity.entity_id,
   ...
   FROM ((((((((((((((((relationship
     ...
     JOIN accession_document_association cr_ada ON ((cr_ada.accession_id = accession.accession_id)))
     JOIN custom_role_type ON (((custom_role_type.uri_id = network.extended_link_role_uri_id) AND (custom_role_type.document_id = cr_ada.document_id))))
  WHERE ((arcqname.local_name)::text = 'presentationArc'::text)
  ORDER BY entity.entity_id, accession.accession_id, custom_role_type.definition, relationship.tree_sequence;


--
-- Name: seq_reference_part; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: reference_part; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: relationship_full_view; Type: VIEW; Schema: public; Owner: -
--
...
CREATE VIEW relationship_full_view AS
 SELECT relationship.relationship_id,
   ...
   FROM (((((((((((((((relationship
     ...
     JOIN accession ON ((network.accession_id = accession.accession_id)))
     JOIN qname elqname ON ((network.extended_link_qname_id = elqname.qname_id)))
     JOIN uri elroleuri ON ((network.extended_link_role_uri_id = elroleuri.uri_id)))
     JOIN qname arcqname ON ((network.arc_qname_id = arcqname.qname_id)))
     JOIN uri arcroleuri ON ((network.arcrole_uri_id = arcroleuri.uri_id)))
     LEFT JOIN element from_element ON ((relationship.from_element_id = from_element.element_id)))
     JOIN qname from_element_qname ON ((from_element.qname_id = from_element_qname.qname_id)))
     FULL JOIN element to_element ON ((relationship.to_element_id = to_element.element_id)))
     LEFT JOIN qname to_element_qname ON ((to_element.qname_id = to_element_qname.qname_id)))
     FULL JOIN resource from_resource ON ((relationship.from_resource_id = from_resource.resource_id)))
     LEFT JOIN qname from_resource_qname ON ((from_resource.qname_id = from_resource_qname.qname_id)))
     FULL JOIN resource to_resource ON ((relationship.to_resource_id = to_resource.resource_id)))
     LEFT JOIN qname to_resource_qname ON ((to_resource.qname_id = to_resource_qname.qname_id)))
     JOIN entity ON ((accession.entity_id = entity.entity_id)))
  ORDER BY entity.entity_id, accession.accession_id, relationship.relationship_id;
...
--
-- Name: report_document_report_document_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE report_document_report_document_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: report_document_report_document_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE report_document_report_document_id_seq OWNED BY report_document.report_document_id;


--
-- Name: report_element_report_element_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE report_element_report_element_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: report_element_report_element_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE report_element_report_element_id_seq OWNED BY report_element.report_element_id;
...
--
-- Name: seq_accession; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: seq_accession_document_association; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: seq_element_attribute; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: seq_reference_part_type; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: seq_reference_resource; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: seq_sic_code; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: seq_unit; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: seq_unit_measure; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: sic_code; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: signal_summary; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE signal_summary (
    accession_id integer NOT NULL,
    entity_name character varying NOT NULL,
    efm_errors integer NOT NULL,
    efm_warnings integer NOT NULL,
    efm_incons integer NOT NULL,
    efm_bestpracs integer NOT NULL,
    efm_infos integer NOT NULL,
    efm_total integer NOT NULL,
    im_errors integer NOT NULL,
    im_warnings integer NOT NULL,
    im_incons integer NOT NULL,
    im_bestpracs integer NOT NULL,
    im_infos integer NOT NULL,
    im_total integer NOT NULL
);
...
--
-- Name: standard_role_definition; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE standard_role_definition (
    standard_role_definition_id integer NOT NULL,
    uri text NOT NULL,
    label text,
    definition text
);
...
--
-- Name: standard_role_definition_standard_role_definition_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE standard_role_definition_standard_role_definition_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: standard_role_definition_standard_role_definition_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE standard_role_definition_standard_role_definition_id_seq OWNED BY standard_role_definition.standard_role_definition_id;


--
-- Name: tabular_facts_by_element; Type: VIEW; Schema: public; Owner: -
--

CREATE VIEW tabular_facts_by_element AS
 SELECT foo.entity_name,
    foo.entity_code,
    foo.axis,
    foo.member,
    foo.local_name,
    max(foo.y2007) AS "Y_2007",
    max(foo.q12008) AS "Q1_2008",
    max(foo.q22008) AS "Q2_2008",
    max(foo.q32008) AS "Q3_2008",
    max(foo.q42008) AS "Q4_2008",
    max(foo.y2008) AS "Y_2008",
    max(foo.q12009) AS "Q1_2009",
    max(foo.q22009) AS "Q2_2009",
    max(foo.q32009) AS "Q3_2009",
    max(foo.q42009) AS "Q4_2009",
    max(foo.y2009) AS "Y_2009",
    max(foo.q12010) AS "Q1_2010",
    max(foo.q22010) AS "Q2_2010",
    max(foo.q32010) AS "Q3_2010",
    max(foo.q42010) AS "Q4_2010",
    max(foo.y2010) AS "Y_2010"
   FROM ( SELECT period_fact_element_view.entity_name,
            period_fact_element_view.entity_code,
            period_fact_element_view.axis,
            period_fact_element_view.member,
            period_fact_element_view.local_name,
                CASE
                    WHEN ((period_fact_element_view.year = (2007)::double precision) AND (period_fact_element_view.period = 'Y'::text)) THEN period_fact_element_view.amount
                    ELSE NULL::numeric
                END AS y2007,
                CASE
                    WHEN ((period_fact_element_view.year = (2008)::double precision) AND (period_fact_element_view.period = '1Q'::text)) THEN period_fact_element_view.amount
                    ELSE NULL::numeric
                END AS q12008,
                CASE
                    WHEN ((period_fact_element_view.year = (2008)::double precision) AND (period_fact_element_view.period = '2Q'::text)) THEN period_fact_element_view.amount
                    ELSE NULL::numeric
                END AS q22008,
                CASE
                    WHEN ((period_fact_element_view.year = (2008)::double precision) AND (period_fact_element_view.period = '3Q'::text)) THEN period_fact_element_view.amount
                    ELSE NULL::numeric
                END AS q32008,
                CASE
                    WHEN ((period_fact_element_view.year = (2008)::double precision) AND (period_fact_element_view.period = '4Q'::text)) THEN period_fact_element_view.amount
                    ELSE NULL::numeric
                END AS q42008,
                CASE
                    WHEN ((period_fact_element_view.year = (2008)::double precision) AND (period_fact_element_view.period = 'Y'::text)) THEN period_fact_element_view.amount
                    ELSE NULL::numeric
                END AS y2008,
                CASE
                    WHEN ((period_fact_element_view.year = (2009)::double precision) AND (period_fact_element_view.period = '1Q'::text)) THEN period_fact_element_view.amount
                    ELSE NULL::numeric
                END AS q12009,
                CASE
                    WHEN ((period_fact_element_view.year = (2009)::double precision) AND (period_fact_element_view.period = '2Q'::text)) THEN period_fact_element_view.amount
                    ELSE NULL::numeric
                END AS q22009,
                CASE
                    WHEN ((period_fact_element_view.year = (2009)::double precision) AND (period_fact_element_view.period = '3Q'::text)) THEN period_fact_element_view.amount
                    ELSE NULL::numeric
                END AS q32009,
                CASE
                    WHEN ((period_fact_element_view.year = (2009)::double precision) AND (period_fact_element_view.period = '4Q'::text)) THEN period_fact_element_view.amount
                    ELSE NULL::numeric
                END AS q42009,
                CASE
                    WHEN ((period_fact_element_view.year = (2009)::double precision) AND (period_fact_element_view.period = 'Y'::text)) THEN period_fact_element_view.amount
                    ELSE NULL::numeric
                END AS y2009,
                CASE
                    WHEN ((period_fact_element_view.year = (2010)::double precision) AND (period_fact_element_view.period = '1Q'::text)) THEN period_fact_element_view.amount
                    ELSE NULL::numeric
                END AS q12010,
                CASE
                    WHEN ((period_fact_element_view.year = (2010)::double precision) AND (period_fact_element_view.period = '2Q'::text)) THEN period_fact_element_view.amount
                    ELSE NULL::numeric
                END AS q22010,
                CASE
                    WHEN ((period_fact_element_view.year = (2010)::double precision) AND (period_fact_element_view.period = '3Q'::text)) THEN period_fact_element_view.amount
                    ELSE NULL::numeric
                END AS q32010,
                CASE
                    WHEN ((period_fact_element_view.year = (2010)::double precision) AND (period_fact_element_view.period = '4Q'::text)) THEN period_fact_element_view.amount
                    ELSE NULL::numeric
                END AS q42010,
                CASE
                    WHEN ((period_fact_element_view.year = (2010)::double precision) AND (period_fact_element_view.period = 'Y'::text)) THEN period_fact_element_view.amount
                    ELSE NULL::numeric
                END AS y2010
           FROM period_fact_element_view) foo
  GROUP BY foo.entity_name, foo.entity_code, foo.local_name, foo.axis, foo.member;


--
-- Name: taxonomy_taxonomy_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: taxonomy; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: taxonomy_version_taxonomy_version_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: taxonomy_version; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--
...
CREATE TABLE taxonomy_version (
    ...
    identifier_document_id integer
);


--
-- Name: taxonomy_version_dts; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE taxonomy_version_dts (
    taxonomy_version_dts_id integer NOT NULL,
...
--
-- Name: taxonomy_version_dts_taxonomy_version_dts_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE taxonomy_version_dts_taxonomy_version_dts_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: taxonomy_version_dts_taxonomy_version_dts_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE taxonomy_version_dts_taxonomy_version_dts_id_seq OWNED BY taxonomy_version_dts.taxonomy_version_dts_id;


--
-- Name: unit_base; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: unit_base_unit_base_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE unit_base_unit_base_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: unit_base_unit_base_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE unit_base_unit_base_id_seq OWNED BY unit_base.unit_base_id;


--
-- Name: unit_measure_base_unit_measure_base_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE unit_measure_base_unit_measure_base_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: unit_measure_base_unit_measure_base_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE unit_measure_base_unit_measure_base_id_seq OWNED BY unit_measure_base.unit_measure_base_id;


--
-- Name: unit_report_unit_report_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE unit_report_unit_report_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: unit_report_unit_report_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE unit_report_unit_report_id_seq OWNED BY unit_report.unit_report_id;


--
-- Name: document_structure_id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY document_structure ALTER COLUMN document_structure_id SET DEFAULT nextval('document_structure_document_structure_id_seq'::regclass);


--
-- Name: dts_id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY dts ALTER COLUMN dts_id SET DEFAULT nextval('dts_dts_id_seq'::regclass);


--
-- Name: dts_document_id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY dts_document ALTER COLUMN dts_document_id SET DEFAULT nextval('dts_document_dts_document_id_seq'::regclass);


--
-- Name: dts_element_id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY dts_element ALTER COLUMN dts_element_id SET DEFAULT nextval('dts_element_dts_element_id_seq'::regclass);


--
-- Name: dts_network_id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY dts_network ALTER COLUMN dts_network_id SET DEFAULT nextval('dts_network_dts_network_id_seq'::regclass);


--
-- Name: entity_identifier_id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY entity_identifier ALTER COLUMN entity_identifier_id SET DEFAULT nextval('entity_identifier_entity_identifier_id_seq'::regclass);


--
-- Name: entity_source_id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY entity_source ALTER COLUMN entity_source_id SET DEFAULT nextval('entity_source_entity_source_id_seq'::regclass);


--
-- Name: namespace_source_id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY namespace_source ALTER COLUMN namespace_source_id SET DEFAULT nextval('namespace_source_namespace_source_id_seq'::regclass);
...
--
-- Name: report_document_id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY report_document ALTER COLUMN report_document_id SET DEFAULT nextval('report_document_report_document_id_seq'::regclass);


--
-- Name: report_element_id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY report_element ALTER COLUMN report_element_id SET DEFAULT nextval('report_element_report_element_id_seq'::regclass);
...
--
-- Name: standard_role_definition_id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY standard_role_definition ALTER COLUMN standard_role_definition_id SET DEFAULT nextval('standard_role_definition_standard_role_definition_id_seq'::regclass);


--
-- Name: taxonomy_version_dts_id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY taxonomy_version_dts ALTER COLUMN taxonomy_version_dts_id SET DEFAULT nextval('taxonomy_version_dts_taxonomy_version_dts_id_seq'::regclass);


--
-- Name: unit_base_id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY unit_base ALTER COLUMN unit_base_id SET DEFAULT nextval('unit_base_unit_base_id_seq'::regclass);


--
-- Name: unit_measure_base_id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY unit_measure_base ALTER COLUMN unit_measure_base_id SET DEFAULT nextval('unit_measure_base_unit_measure_base_id_seq'::regclass);


--
-- Name: unit_report_id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY unit_report ALTER COLUMN unit_report_id SET DEFAULT nextval('unit_report_unit_report_id_seq'::regclass);
...
--
-- Name: base_namespace_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY base_namespace
    ADD CONSTRAINT base_namespace_pkey PRIMARY KEY (base_namespace_id);


--
-- Name: context_dimension_explicit_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY context_dimension_explicit
    ADD CONSTRAINT context_dimension_explicit_pkey PRIMARY KEY (context_dimension_id);


--
-- Name: context_dimension_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: context_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: custom_arcrole_type_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: custom_arcrole_used_on_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: custom_role_type_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: document_structure_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY document_structure
    ADD CONSTRAINT document_structure_pkey PRIMARY KEY (document_structure_id);


--
-- Name: dts_document_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY dts_document
    ADD CONSTRAINT dts_document_pkey PRIMARY KEY (dts_document_id);


--
-- Name: dts_element_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY dts_element
    ADD CONSTRAINT dts_element_pkey PRIMARY KEY (dts_element_id);


--
-- Name: dts_network_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY dts_network
    ADD CONSTRAINT dts_network_pkey PRIMARY KEY (dts_network_id);


--
-- Name: dts_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY dts
    ADD CONSTRAINT dts_pkey PRIMARY KEY (dts_id);


--
-- Name: element_attribute_association_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: entity_identifier_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY entity_identifier
    ADD CONSTRAINT entity_identifier_pkey PRIMARY KEY (entity_identifier_id);


--
-- Name: entity_name_history_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: entity_source_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY entity_source
    ADD CONSTRAINT entity_source_pkey PRIMARY KEY (entity_source_id);


--
-- Name: enumeration_arcrole_cycles_allowed_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: enumeration_element_balance_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: enumeration_element_period_type_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: enumeration_unit_measure_location_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: fact_pkey1; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY fact
    ADD CONSTRAINT fact_pkey1 PRIMARY KEY (fact_id);


--
-- Name: industry_level_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: industry_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: industry_structure_industry_classification_depth_key; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: industry_structure_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: namespace_source_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY namespace_source
    ADD CONSTRAINT namespace_source_pkey PRIMARY KEY (namespace_source_id);


--
-- Name: pk_footnote_resouce; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY footnote_resource
    ADD CONSTRAINT pk_footnote_resouce PRIMARY KEY (resource_id);


--
-- Name: pk_label_resouce; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: qname_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: reference_part_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--
...
ALTER TABLE ONLY dts_relationship
    ADD CONSTRAINT relationship_pkey PRIMARY KEY (dts_relationship_id);


--
-- Name: report_document_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY report_document
    ADD CONSTRAINT report_document_pkey PRIMARY KEY (report_document_id);


--
-- Name: report_element_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY report_element
    ADD CONSTRAINT report_element_pkey PRIMARY KEY (report_element_id);
...
--
-- Name: sic_code_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: standard_role_definition_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY standard_role_definition
    ADD CONSTRAINT standard_role_definition_pkey PRIMARY KEY (standard_role_definition_id);


--
-- Name: taxonomy_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: taxonomy_version_dts_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY taxonomy_version_dts
    ADD CONSTRAINT taxonomy_version_dts_pkey PRIMARY KEY (taxonomy_version_dts_id);


--
-- Name: taxonomy_version_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: unit_base_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY unit_base
    ADD CONSTRAINT unit_base_pkey PRIMARY KEY (unit_base_id);


--
-- Name: unit_measure_base_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY unit_measure_base
    ADD CONSTRAINT unit_measure_base_pkey PRIMARY KEY (unit_measure_base_id);


--
-- Name: unit_report_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY unit_report
    ADD CONSTRAINT unit_report_pkey PRIMARY KEY (unit_report_id);


--
-- Name: uri_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: used_on_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: attribute_value_index01; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: base_namespace_index01; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE UNIQUE INDEX base_namespace_index01 ON base_namespace USING btree (source_id, preface);


--
-- Name: conext_dimension_explicit_index03; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX conext_dimension_explicit_index03 ON context_dimension_explicit USING btree (dimension_qname_id, member_qname_id);


--
-- Name: conext_dimension_index03; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: context_dimension_explicit_index01; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX context_dimension_explicit_index01 ON context_dimension_explicit USING btree (context_id);


--
-- Name: context_dimension_explicit_index02; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX context_dimension_explicit_index02 ON context_dimension_explicit USING btree (member_qname_id, dimension_qname_id);


--
-- Name: context_dimension_explicit_index04; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX context_dimension_explicit_index04 ON context_dimension_explicit USING btree (member_qname_id);


--
-- Name: context_dimension_explicit_index05; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX context_dimension_explicit_index05 ON context_dimension_explicit USING btree (dimension_qname_id);


--
-- Name: context_dimension_explicit_index06; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE UNIQUE INDEX context_dimension_explicit_index06 ON context_dimension_explicit USING btree (dimension_qname_id, context_id);


--
-- Name: context_dimension_index01; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: context_dimension_index02; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: context_dimension_index04; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: context_dimension_index05; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: context_dimension_index06; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: context_index01; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: context_index02; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: context_index03; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: context_index04; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE UNIQUE INDEX context_index04 ON context USING btree (fiscal_year, fiscal_period, context_id);


--
-- Name: context_index05; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE UNIQUE INDEX context_index05 ON context USING btree (fiscal_year, context_id);


--
-- Name: context_index06; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE UNIQUE INDEX context_index06 ON context USING btree (fiscal_period, context_id);


--
-- Name: context_index07; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE UNIQUE INDEX context_index07 ON context USING btree (fiscal_period, fiscal_year, context_id);


--
-- Name: custom_arcrole_type_index01; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: custom_arcrole_type_index02; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX custom_arcrole_type_index02 ON custom_arcrole_type USING btree (document_id);


--
-- Name: custom_role_type_index01; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX custom_role_type_index01 ON custom_role_type USING btree (uri_id);


--
-- Name: custom_role_type_index02; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX custom_role_type_index02 ON custom_role_type USING btree (document_id);


--
-- Name: custom_role_used_on_ix; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: document_index01; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: document_structure_index01; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE UNIQUE INDEX document_structure_index01 ON document_structure USING btree (parent_document_id, child_document_id);


--
-- Name: dts_document_index01; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE UNIQUE INDEX dts_document_index01 ON dts_document USING btree (dts_id, document_id);


--
-- Name: dts_document_index02; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE UNIQUE INDEX dts_document_index02 ON dts_document USING btree (document_id, dts_id);


--
-- Name: dts_element_index01; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE UNIQUE INDEX dts_element_index01 ON dts_element USING btree (dts_id, element_id);


--
-- Name: dts_element_index02; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE UNIQUE INDEX dts_element_index02 ON dts_element USING btree (element_id, dts_id);


--
-- Name: dts_index01; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE UNIQUE INDEX dts_index01 ON dts USING btree (dts_hash);


--
-- Name: dts_network_index01; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX dts_network_index01 ON dts_network USING btree (dts_id);


--
-- Name: dts_network_index02; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX dts_network_index02 ON dts_network USING btree (arcrole_uri_id);


--
-- Name: element_attribute_association_index01; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: element_index01; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: element_index02; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: element_index03; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: element_index04; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX element_index04 ON element USING btree (datatype_qname_id);


--
-- Name: element_index05; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX element_index05 ON element USING btree (xbrl_base_datatype_qname_id);


--
-- Name: entity_index01; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: entity_index02; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: entity_name_history_index01; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: entity_source_index01; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE UNIQUE INDEX entity_source_index01 ON entity_source USING btree (source_id, entity_id);


--
-- Name: entity_ts_index03; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: fact_index01; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: fact_index02; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: fact_index03; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: fact_index04; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: fact_index05; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: fact_index06; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: fact_index07; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: fact_index08; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: fact_index09; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: fact_index10; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX fact_index10 ON fact USING btree (fact_hash, fact_id);


--
-- Name: fact_index11; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX fact_index11 ON fact USING btree (calendar_hash, fact_id);


--
-- Name: fact_index12; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX fact_index12 ON fact USING btree (fact_id, fact_hash);


--
-- Name: fact_index13; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX fact_index13 ON fact USING btree (fact_id, calendar_hash);


--
-- Name: fact_index14; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX fact_index14 ON fact USING btree (fact_id, ultimus_index);


--
-- Name: fact_index15; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX fact_index15 ON fact USING btree (ultimus_index, fact_id);


--
-- Name: fact_index16; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX fact_index16 ON fact USING btree (fact_id, uom, ultimus_index, calendar_ultimus_index);


--
-- Name: fact_index17; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE UNIQUE INDEX fact_index17 ON fact USING btree (fiscal_ultimus_index, fact_id);


--
-- Name: fact_index18; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE UNIQUE INDEX fact_index18 ON fact USING btree (fact_id, fiscal_ultimus_index);


--
-- Name: fact_index19; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE UNIQUE INDEX fact_index19 ON fact USING btree (fiscal_hash, fact_id);


--
-- Name: fact_index20; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX fact_index20 ON fact USING btree (tuple_fact_id);


--
-- Name: fact_index21; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX fact_index21 ON fact USING btree (unit_base_id);


--
-- Name: fact_ts_index03; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: industry_industry_classification_industry_code_idx; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: industry_level_index01; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: industry_level_index02; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: label_resource_index01; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: label_resource_ts_index02; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: namespace_idx01; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: namespace_idx02; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: namespace_source_index01; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE UNIQUE INDEX namespace_source_index01 ON namespace_source USING btree (namespace_id, source_id);


--
-- Name: qname_index01; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: qname_index02; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: qname_index03; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: qname_index04; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: qname_index05; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: qname_index07; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: qname_ts_index06; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: reference_part_index01; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX reference_part_index01 ON reference_part USING btree (resource_id, qname_id);


--
-- Name: reference_part_index02; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX reference_part_index02 ON reference_part USING btree (qname_id, resource_id);


--
-- Name: relationship_element_resource_index01; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX relationship_element_resource_index01 ON dts_relationship USING btree (from_element_id, to_resource_id);


--
-- Name: relationship_element_resource_index02; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX relationship_element_resource_index02 ON dts_relationship USING btree (to_resource_id, from_element_id);


--
-- Name: relationship_from_res_ix; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX relationship_from_res_ix ON dts_relationship USING btree (from_resource_id);


--
-- Name: relationship_index01; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX relationship_index01 ON dts_relationship USING btree (from_element_id);


--
-- Name: relationship_index02; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX relationship_index02 ON dts_relationship USING btree (to_element_id, dts_network_id);


--
-- Name: relationship_index03; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX relationship_index03 ON dts_relationship USING btree (dts_network_id, from_element_id, to_element_id);


--
-- Name: relationship_to_res_ix; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX relationship_to_res_ix ON dts_relationship USING btree (to_resource_id);


--
-- Name: report_document_index01; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE UNIQUE INDEX report_document_index01 ON report_document USING btree (report_id, document_id);


--
-- Name: report_document_index02; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE UNIQUE INDEX report_document_index02 ON report_document USING btree (document_id, report_id);


--
-- Name: report_element_index01; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE UNIQUE INDEX report_element_index01 ON report_element USING btree (report_id, element_id);


--
-- Name: report_element_index02; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE UNIQUE INDEX report_element_index02 ON report_element USING btree (element_id, report_id);


--
-- Name: report_index01; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE UNIQUE INDEX report_index01 ON report USING btree (source_report_identifier, source_id);


--
-- Name: report_index02; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX report_index02 ON report USING btree (entity_id);


--
-- Name: report_index03; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX report_index03 ON report USING btree (accepted_timestamp DESC);


--
-- Name: report_index04; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX report_index04 ON report USING btree ((((properties ->> 'standard_industrial_classificaiton'::text))::integer));


--
-- Name: report_index_05; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX report_index_05 ON report USING btree (source_id);


--
-- Name: report_index_06; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX report_index_06 ON report USING btree (dts_id);


--
-- Name: report_ts_index03; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX report_ts_index03 ON report USING gin (to_tsvector('english'::regconfig, entity_name));


--
-- Name: resource_index01; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE UNIQUE INDEX resource_index01 ON resource USING btree (document_id, document_line_number, document_column_number, xml_location);


--
-- Name: resource_index02; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: resource_index03; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE UNIQUE INDEX resource_index03 ON resource USING btree (document_id, xml_location);


--
-- Name: signal_summary_index01; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE UNIQUE INDEX signal_summary_index01 ON signal_summary USING btree (accession_id);


--
-- Name: unit_base_index01; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE UNIQUE INDEX unit_base_index01 ON unit_base USING btree (unit_hash);


--
-- Name: unit_measure_base_index01; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX unit_measure_base_index01 ON unit_measure_base USING btree (unit_base_id);


--
-- Name: unit_report_index01; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE UNIQUE INDEX unit_report_index01 ON unit_report USING btree (report_id, unit_xml_id);


--
-- Name: unit_report_index02; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX unit_report_index02 ON unit_report USING btree (unit_base_id);


--
-- Name: uri_index01; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: entity_identifier_entity_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY entity_identifier
    ADD CONSTRAINT entity_identifier_entity_id_fkey FOREIGN KEY (entity_id) REFERENCES entity(entity_id);


--
-- Name: entity_name_history_entity_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: fk_arcrole_cycles; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: fk_attribute_value_qname; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: fk_context_dimension_dimension; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: fk_context_dimension_dimension_qname; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: fk_context_dimension_member_qname; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: fk_context_dimension_typed_qname; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: fk_custom_arcrole_type_document; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: fk_custom_role_type; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: fk_custom_role_type_uri; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: fk_dts_document_document; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY dts_document
    ADD CONSTRAINT fk_dts_document_document FOREIGN KEY (document_id) REFERENCES document(document_id);


--
-- Name: fk_dts_document_dts; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY dts_document
    ADD CONSTRAINT fk_dts_document_dts FOREIGN KEY (dts_id) REFERENCES dts(dts_id);


--
-- Name: fk_dts_element_dts; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY dts_element
    ADD CONSTRAINT fk_dts_element_dts FOREIGN KEY (dts_id) REFERENCES dts(dts_id);


--
-- Name: fk_dts_element_element; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY dts_element
    ADD CONSTRAINT fk_dts_element_element FOREIGN KEY (element_id) REFERENCES element(element_id);


--
-- Name: fk_dts_network_qname_arc; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY dts_network
    ADD CONSTRAINT fk_dts_network_qname_arc FOREIGN KEY (arc_qname_id) REFERENCES qname(qname_id);


--
-- Name: fk_dts_network_qname_link; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY dts_network
    ADD CONSTRAINT fk_dts_network_qname_link FOREIGN KEY (extended_link_qname_id) REFERENCES qname(qname_id);


--
-- Name: fk_dts_network_report; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY dts_network
    ADD CONSTRAINT fk_dts_network_report FOREIGN KEY (dts_id) REFERENCES dts(dts_id);


--
-- Name: fk_dts_network_uri_arcrole; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY dts_network
    ADD CONSTRAINT fk_dts_network_uri_arcrole FOREIGN KEY (arcrole_uri_id) REFERENCES uri(uri_id);


--
-- Name: fk_dts_network_uri_linkrole; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY dts_network
    ADD CONSTRAINT fk_dts_network_uri_linkrole FOREIGN KEY (extended_link_role_uri_id) REFERENCES uri(uri_id);


--
-- Name: fk_dts_relationship_dts_network; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY dts_relationship
    ADD CONSTRAINT fk_dts_relationship_dts_network FOREIGN KEY (dts_network_id) REFERENCES dts_network(dts_network_id);


--
-- Name: fk_eav_av; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: fk_eav_element; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: fk_element_balance; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: fk_element_datatype_qname; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: fk_element_document; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: fk_element_period_type; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: fk_element_qname; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: fk_element_sg_qname; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: fk_element_xbrl_base_datatype_qname; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: fk_fact_context; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: fk_fact_element; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: fk_fact_fact_tuple; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY fact
    ADD CONSTRAINT fk_fact_fact_tuple FOREIGN KEY (tuple_fact_id) REFERENCES fact(fact_id);


--
-- Name: fk_fact_report; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY fact
    ADD CONSTRAINT fk_fact_report FOREIGN KEY (accession_id) REFERENCES report(report_id);


--
-- Name: fk_fact_unit_unit_base; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY fact
    ADD CONSTRAINT fk_fact_unit_unit_base FOREIGN KEY (unit_base_id) REFERENCES unit_base(unit_base_id);


--
-- Name: fk_fact_unit_unit_report; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: fk_reference_part_resource; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: fk_rel_from_element; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: fk_rel_from_resource; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: fk_rel_to_element; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: fk_rel_to_resource; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: fk_report_document_document; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY report_document
    ADD CONSTRAINT fk_report_document_document FOREIGN KEY (document_id) REFERENCES document(document_id);


--
-- Name: fk_report_document_report; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY report_document
    ADD CONSTRAINT fk_report_document_report FOREIGN KEY (report_id) REFERENCES report(report_id);


--
-- Name: fk_report_dts; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY report
    ADD CONSTRAINT fk_report_dts FOREIGN KEY (dts_id) REFERENCES dts(dts_id);


--
-- Name: fk_report_dts_entry; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY report
    ADD CONSTRAINT fk_report_dts_entry FOREIGN KEY (entry_dts_id) REFERENCES dts(dts_id);


--
-- Name: fk_report_element_element; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY report_element
    ADD CONSTRAINT fk_report_element_element FOREIGN KEY (element_id) REFERENCES element(element_id);


--
-- Name: fk_report_element_report; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY report_element
    ADD CONSTRAINT fk_report_element_report FOREIGN KEY (report_id) REFERENCES report(report_id);


--
-- Name: fk_report_entity; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY report
    ADD CONSTRAINT fk_report_entity FOREIGN KEY (entity_id) REFERENCES entity(entity_id);


--
-- Name: fk_resource_document; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: fk_resource_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: fk_resource_qname; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: fk_resource_role_uri; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: fk_unit_measure_base_unit_base; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY unit_measure_base
    ADD CONSTRAINT fk_unit_measure_base_unit_base FOREIGN KEY (unit_base_id) REFERENCES unit_base(unit_base_id);


--
-- Name: fk_unit_report_report; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY unit_report
    ADD CONSTRAINT fk_unit_report_report FOREIGN KEY (report_id) REFERENCES report(report_id);


--
-- Name: fk_unit_report_unit_base; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY unit_report
    ADD CONSTRAINT fk_unit_report_unit_base FOREIGN KEY (unit_base_id) REFERENCES unit_base(unit_base_id);


--
-- Name: fk_used_on_custom_arcrole_type; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: fk_used_on_custom_role_type; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: fk_used_on_qname; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: namespace_taxonomy_version_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: role_type_role_type_label; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: taxonomy_version_taxonomy_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
COPY enumeration_arcrole_cycles_allowed (enumeration_arcrole_cycles_allowed_id, description) FROM stdin;
1	any
2	undirected
3	none
\.

SELECT pg_catalog.setval('seq_enumeration_arcrole_cycles_allowed', 3, true);

--
-- Data for Name: enumeration_element_balance; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY enumeration_element_balance (enumeration_element_balance_id, description) FROM stdin;
1	debit
2	credit
\.

SELECT pg_catalog.setval('seq_enumeration_element_balance', 3, true);

--
-- Data for Name: enumeration_element_period_type; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY enumeration_element_period_type (enumeration_element_period_type_id, description) FROM stdin;
1	instant
2	duration
3	forever
\.

SELECT pg_catalog.setval('seq_enumeration_element_period_type', 3, true);

--
-- Data for Name: enumeration_unit_measure_location; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY enumeration_unit_measure_location (enumeration_unit_measure_location_id, description) FROM stdin;
1	measure
2	numerator
3	denominator
\.

SELECT pg_catalog.setval('seq_enumeration_unit_measure_location', 3, true);

--
-- Data for Name: industry; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY industry (industry_id, industry_classification, industry_code, industry_description, depth, parent_id) FROM stdin;
4315	SEC	3576	Compuer Communications Equipment	4	2424
...
4326	SEC	6532	Real Estate Deailers (for their own account)	4	2694
...
4336	SEC	99	Miscellaneous	1	\N
1	NAICS	11	Agriculture, Forestry, Fishing and Hunting	1	\N
132	NAICS	21	Mining, Quarrying, and Oil and Gas Extraction	1	\N
98	NAICS	113	Forestry and Logging	2	1
180	NAICS	22	Utilities	1	\N
205	NAICS	23	Construction	1	\N
278	NAICS	31	Manufacturing	4	\N
572	NAICS	327	Nonmetallic Mineral Product Manufacturing	2	278
700	NAICS	333	Machinery Manufacturing	2	278
930	NAICS	42	Wholesale Trade	1	\N
1095	NAICS	44	Retail Trade	4	\N
1194	NAICS	4482	Shoe Stores	3	1180
1262	NAICS	48	Transportation and Warehousing	4	\N
1273	NAICS	482	Rail Transportation	2	1262
1402	NAICS	51	Information	1	\N
1480	NAICS	52	Finance and Insurance	1	\N
1569	NAICS	53	Real Estate and Rental and Leasing	1	\N
1624	NAICS	54	Professional, Scientific, and Technical Services	1	\N
1591	NAICS	532	Rental and Leasing Services	2	1569
1718	NAICS	55	Management of Companies and Enterprises	1	\N
1725	NAICS	56	Administrative and Support and Waste Management and Remediation Services	1	\N
1812	NAICS	61	Educational Services	1	\N
1850	NAICS	62	Health Care and Social Assistance	1	\N
1942	NAICS	71	Arts, Entertainment, and Recreation	1	\N
2003	NAICS	72	Accommodation and Food Services	1	\N
2037	NAICS	81	Other Services (except Public Administration)	1	\N
2071	NAICS	812	Personal and Laundry Services	2	2037
2135	NAICS	92	Public Administration	1	\N
...
2797	SEC	90	Public Administration	1	\N
2789	SEC	10	Mining	1	\N
2790	SEC	15	Construction	1	\N
2791	SEC	20	Manufacturing	1	\N
2792	SEC	40	Transportation, Communications, Eletric, Gas and Sanitary Services	1	\N
2793	SEC	50	Wholesale Trade	1	\N
2794	SEC	52	Retail Trade	1	\N
2795	SEC	60	Finance, Insurance, and Real Estate	1	\N
2796	SEC	70	Services	1	\N
4314	SIC	90	Public Administration	1	\N
4306	SIC	10	Mining	1	\N
4307	SIC	15	Construction	1	\N
4308	SIC	20	Manufacturing	1	\N
4309	SIC	40	Transportation, Communications, Eletric, Gas and Sanitary Services	1	\N
4310	SIC	50	Wholesale Trade	1	\N
4311	SIC	52	Retail Trade	1	\N
4312	SIC	60	Finance, Insurance, and Real Estate	1	\N
4313	SIC	70	Services	1	\N
2788	SEC	1	Agriculture, Forestry, And Fishing	1	\N
4305	SIC	1	Agriculture, Forestry, And Fishing	1	\N
...
--
-- Name: industry_industry_id_seq1; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('industry_industry_id_seq1', 4340, true);
...
COPY industry_level (industry_level_id, industry_classification, ancestor_id, ancestor_code, ancestor_depth, descendant_id, descendant_code, descendant_depth) FROM stdin;
...
--
-- Name: industry_level_industry_level_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('industry_level_industry_level_id_seq', 9326, true);


--
-- Data for Name: industry_structure; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY industry_structure (industry_structure_id, industry_classification, depth, level_name) FROM stdin;
1	SIC	1	Division
2	SIC	2	Major Group
3	SEC	1	Division
4	SEC	2	Major Group
5	SEC	3	Industry Group
6	SEC	4	Industry
7	NAICS	1	Economic Sector
8	NAICS	2	Subsector
9	NAICS	3	Industry Group
10	NAICS	4	NAICS Industry
11	NAICS	5	National Industry
\.


--
-- Name: industry_structure_industry_structure_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('industry_structure_industry_structure_id_seq', 11, true);


--
-- Data for Name: sic_code
--

COPY sic_code (sic_code_id, description) FROM stdin;
...
SELECT pg_catalog.setval('seq_sic_code', 444, true);
...
SELECT pg_catalog.setval('taxonomy_taxonomy_id_seq', 4, true);


--
-- Data for Name: taxonomy_version; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY taxonomy_version (taxonomy_version_id, taxonomy_id, version, identifier_document_id) FROM stdin;
1	1	2008	1
2	1	2009	2
3	1	2011	3
8	1	2012	4
