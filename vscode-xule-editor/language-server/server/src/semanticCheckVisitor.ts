...
export const wellKnownFunctions: { [name: string]: FunctionInfo } = {
    ...
    "concepts-by-trait": new FunctionInfo(2),
    ...
    "to-spreadsheet": new FunctionInfo(1),
    "traits": new FunctionInfo(1),
...
export const wellKnownProperties: { [name: string]: PropertyInfo } = {
    ...
    "concepts-by-trait": new PropertyInfo(1),
    ...
    "to-spreadsheet": new PropertyInfo(0),
