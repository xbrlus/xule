...
def property_traits(xule_context, object_value, *args):
    ...
    concepts |= get_parents(object_value.value, (_CLASS_SUBCLASS_2021, _CLASS_SUBCLASS_2023))
    for concept in concepts:
        traits |= get_parents(concept, (_TRAIT_CONCEPT_2021, _TRAIT_CONCEPT_2023))
...
def get_parents(concept, arc_roles):
    ...
    for network_info in network_infos:
        ...
        for parent in  network.toModelObject(concept):
            traits.add(parent.fromModelObject)
