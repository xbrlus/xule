...
--
-- This psql script requires the variable dbname to be set when invoking the script.
...
$$
BEGIN
	IF NOT EXISTS (SELECT 1 FROM pg_roles WHERE rolname = 'edgar_db_view_all') THEN
		
			CREATE ROLE  edgar_db_view_all
...
$$
BEGIN
	IF NOT EXISTS (SELECT 1 FROM pg_roles WHERE rolname = 'edgar_db_write_all') THEN
		
			CREATE ROLE  edgar_db_write_all
			  NOSUPERUSER INHERIT NOCREATEDB NOCREATEROLE NOREPLICATION;
	END IF;
END
$$;
...
CREATE OR REPLACE FUNCTION delete_accession(in_accession_id bigint) RETURNS integer
    LANGUAGE plpgsql
    AS $$
...
DECLARE
  ...
  m_entity_id INTEGER;
BEGIN
	SELECT entity_id INTO m_entity_id FROM accession WHERE accession_id = in_accession_id;

	DELETE FROM fact_aug USING fact WHERE fact.accession_id = in_accession_id AND fact.fact_id = fact_aug.fact_id;
	...
	DELETE FROM context_aug USING context WHERE context.accession_id = in_accession_id AND context.context_id = context_aug.context_id;
...
--
CREATE FUNCTION hash_fact_string(fact_id_arg integer)
...
CREATE FUNCTION hash_calendar_string(fact_id_arg integer)
  RETURNS character varying AS
$BODY$
...
ALTER FUNCTION public.hash_calendar_string(fact_id_arg integer) OWNER TO postgres;
...
CREATE TABLE accession (
	...
	entry_type character varying DEFAULT 'instance' NOT NULL,
...
CREATE TABLE accession_document_association (
    accession_document_association_id serial NOT NULL,
    accession_id integer NOT NULL,
...
CREATE OR REPLACE FUNCTION get_simple_fact_by_accession(
    prefix_arg character varying,
    local_name_arg character varying,
...
ALTER FUNCTION get_simple_fact_by_accession(character varying, character varying, integer, anyelement)
  OWNER TO postgres;



CREATE TABLE accession_element (
    accession_element_id serial NOT NULL,
    accession_id integer NOT NULL,
...
--
-- Name: base_namespace; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE base_namespace (
    base_namespace_id serial NOT NULL,
    preface character varying NOT NULL,
    prefix_expression character varying
);


ALTER TABLE public.base_namespace OWNER TO postgres;
...
CREATE TABLE custom_role_type (
    custom_role_type_id serial NOT NULL,
...
CREATE TABLE context_dimension (
    context_dimension_id serial NOT NULL,
    context_id integer NOT NULL,
...
--
-- Name: context_dimension_explicit; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--
...
ALTER TABLE public.context_dimension_explicit OWNER TO postgres;
...
CREATE TABLE custom_arcrole_type (
    custom_arcrole_type_id serial NOT NULL,
    document_id integer NOT NULL,
    uri_id integer NOT NULL,
    definition character varying(2048),
...
CREATE TABLE custom_arcrole_used_on (
    custom_arcrole_used_on_id serial NOT NULL,
...
CREATE TABLE custom_role_used_on (
    custom_role_used_on_id serial NOT NULL,
...
CREATE TABLE element_attribute (
    element_attribute_id serial NOT NULL,
    element_id integer NOT NULL,
...
CREATE TABLE element_attribute_value_association (
    element_attribute_value_association_id serial NOT NULL,
    element_id integer NOT NULL,
...
--
-- Name: footnote_resource; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--
...
ALTER TABLE public.footnote_resource OWNER TO postgres;
...
CREATE TABLE entity_name_history (
    entity_name_history_id serial NOT NULL,
    entity_id integer NOT NULL,
    accession_id integer NOT NULL,
    entity_name character varying
);
...
CREATE TABLE enumeration_arcrole_cycles_allowed (
    enumeration_arcrole_cycles_allowed_id serial NOT NULL,
...
CREATE TABLE enumeration_element_balance (
    enumeration_element_balance_id serial NOT NULL,
    description character varying(30) NOT NULL
);
...
CREATE TABLE enumeration_element_period_type (
    enumeration_element_period_type_id serial NOT NULL,
    description character varying(30) NOT NULL
);
...
CREATE TABLE enumeration_unit_measure_location (
    enumeration_unit_measure_location_id serial NOT NULL,
    description character varying(30) NOT NULL
);
...
CREATE TABLE unit_measure (
    unit_measure_id serial NOT NULL,
...
CREATE TABLE industry_level (
    industry_level_id serial NOT NULL,
    industry_classification character varying,
    ancestor_id integer,
...
CREATE TABLE industry_structure (
    industry_structure_id serial NOT NULL,
...
CREATE TABLE reference_part (
    reference_part_id serial NOT NULL,
...
CREATE TABLE taxonomy_version (
    taxonomy_version_id serial NOT NULL,
...
--
-- Name: base_namespace_id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY base_namespace ALTER COLUMN base_namespace_id SET DEFAULT nextval('base_namespace_base_namespace_id_seq'::regclass);



--
-- Data for Name: base_namespace; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY base_namespace (base_namespace_id, preface, prefix_expression) FROM stdin;
1	^http://xbrl.us/	\N
2	^http://xbrl.us/[^/]+/\\d\\d\\d\\d-\\d\\d-\\d\\d$	^http://xbrl.us/([^/]+)/\\d\\d\\d\\d-\\d\\d-\\d\\d$
3	^http://www.xbrl.org/	\N
4	^http://xbrl.org/	\N
5	^http://www.w3.org/	\N
6	^http://ici.org/	\N
7	^http://fasb.org/	^http://[^/]*/([^/]*)/
8	^http://xbrl.sec.gov/	^http://[^/]*/([^/]*)/
9	^http://www.xbrl.org/dtr/	^http://[^/]*/[^/]*/[^/]*/([^/]*)
10	^http://www.xbrl.org/2009/role/negated	^http://[^/]*/[^/]*/[^/]*/([^/]*)
\.


--
-- Name: base_namespace_base_namespace_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('base_namespace_base_namespace_id_seq', 10, true);
...
SELECT pg_catalog.setval('document_document_id_seq', 8, true);
...
SELECT pg_catalog.setval('enumeration_arcrole_cycles_al_enumeration_arcrole_cycles_al_seq', 3, true);
...
SELECT pg_catalog.setval('enumeration_element_balance_enumeration_element_balance_id_seq', 3, true);
...
SELECT pg_catalog.setval('enumeration_element_period_ty_enumeration_element_period_ty_seq', 3, true);
...
SELECT pg_catalog.setval('enumeration_unit_measure_loca_enumeration_unit_measure_loca_seq', 3, true);
...
SELECT pg_catalog.setval('industry_industry_id_seq', 4340, true);
...
--
/*
COPY namespace (namespace_id, uri, is_base, taxonomy_version_id, prefix, name) FROM stdin;
1	http://xbrl.sec.gov/dei/2011-01-31	t	3	dei	Document Entity Information
2	http://xbrl.sec.gov/invest/2011-01-31	t	3	invest	Investment
3	http://xbrl.sec.gov/naics/2011-01-31	t	3	naics	North American Industry Classification System
4	http://xbrl.us/exch/2009-01-31	t	2	exch	Exchange Listing
5	http://xbrl.sec.gov/country/2011-01-31	t	3	country	Country Listing
6	http://xbrl.us/us-gaap/add1/2009-01-31	t	2	add1	Addendum 1
7	http://xbrl.us/currency/2009-01-31	t	2	currency	Currency Listing
8	http://xbrl.sec.gov/exch/2011-01-31	t	3	exch	Exchange Listing
9	http://xbrl.sec.gov/stpr/2011-01-31	t	3	stpr	State/Province Listing
10	http://fasb.org/us-gaap/2011-01-31	t	3	us-gaap	US GAAP Core
11	http://xbrl.us/mr/2009-01-31	t	2	mr	Management Report
12	http://xbrl.us/invest/2009-01-31	t	2	invest	Investment
13	http://xbrl.us/sic/2009-01-31	t	2	sic	Standard Industrial Classification
14	http://xbrl.us/mr/2008-03-31	t	1	mr	Management Report
15	http://xbrl.us/exch/2008-03-31	t	1	exch	Exchange Listing
16	http://xbrl.us/dei/2008-03-31	t	1	dei	Document Entity Information
17	http://xbrl.us/seccert/2008-03-31	t	1	seccert	SEC Certification
18	http://xbrl.us/country/2008-03-31	t	1	country	Country Listing
19	http://xbrl.us/sic/2008-03-31	t	1	sic	Standard Industrial Classification
20	http://xbrl.us/seccert/2009-01-31	t	2	seccert	SEC Certification
21	http://xbrl.us/currency/2008-03-31	t	1	currency	Currency Listing
22	http://xbrl.us/mda/2008-03-31	t	1	mda	Management Discussion and Analysis
23	http://xbrl.us/ar/2009-01-31	t	2	ar	Accountant's Report
24	http://xbrl.sec.gov/sic/2011-01-31	t	3	sic	Standard Industrial Classification
25	http://xbrl.us/country/2009-01-31	t	2	country	Country Listing
26	http://xbrl.us/naics/2008-03-31	t	1	naics	North American Industry Classification System
27	http://xbrl.us/naics/2009-01-31	t	2	naics	North American Industry Classification System
28	http://xbrl.sec.gov/currency/2011-01-31	t	3	currency	Currency Listing
29	http://xbrl.us/mda/2009-01-31	t	2	mda	Management Discussion and Analysis
30	http://xbrl.us/stpr/2008-03-31	t	1	stpr	State/Province Listing
31	http://xbrl.us/ar/2008-03-31	t	1	ar	Accountant's Report
32	http://xbrl.us/us-gaap/2008-03-31	t	1	us-gaap	US GAAP Core
33	http://xbrl.us/stpr/2009-01-31	t	2	stpr	State/Province Listing
34	http://xbrl.us/dei/2009-01-31	t	2	dei	Document Entity Information
35	http://xbrl.us/us-gaap/2009-01-31	t	2	us-gaap	US GAAP Core
36	http://xbrl.us/ratings/2009-10-31	t	4	ratings	Credit Ratings
37	http://xbrl.sec.gov/rr/2010-02-28	t	5	rr	Risk Return
38	http://ici.org/rr/2006	t	6	rr	Risk Return
39	http://xbrl.org/2005/xbrldt	t	7	xbrldt	XBRL Dimension Taxonomy
40	http://xbrl.sec.gov/dei/2012-01-31	t	8	dei	Document Entity Information
41	http://fasb.org/us-gaap/2012-01-31	t	8	us-gaap	US GAAP Core
42	http://xbrl.sec.gov/currency/2012-01-31	t	8	currency	Currency Listing
43	http://xbrl.sec.gov/exch/2012-01-31	t	8	exch	Exchange Listing
44	http://xbrl.sec.gov/invest/2012-01-31	t	8	invest	Investment
45	http://xbrl.sec.gov/country/2012-01-31	t	8	country	Country Listing
46	http://xbrl.sec.gov/exch/2013-01-31	t	9	exch	Exchange Listing
47	http://xbrl.sec.gov/dei/2013-01-31	t	9	dei	Document Entity Information
48	http://xbrl.sec.gov/invest/2013-01-31	t	9	invest	Investment
49	http://xbrl.sec.gov/country/2013-01-31	t	9	country	Country Listing
50	http://fasb.org/us-gaap/2013-01-31	t	9	us-gaap	US GAAP Core
51	http://xbrl.sec.gov/currency/2014-01-31	t	10	currency	Currency Listing
52	http://xbrl.sec.gov/dei/2014-01-31	t	10	dei	Document Entity Information
53	http://xbrl.sec.gov/exch/2014-01-31	t	10	exch	Exchange Listing
54	http://fasb.org/us-gaap/2014-01-31	t	10	us-gaap	US GAAP Core
55	http://www.xbrl.org/dtr/type/non-numeric	t	0	\N	\N
57	http://www.xbrl.org/2009/role/negated	t	0	\N	\N
58	http://www.xbrl.org/2003/XLink	t	0	\N	\N
59	http://www.xbrl.org/2003/linkbase	t	0	\N	\N
60	http://www.w3.org/1999/xlink	t	0	\N	\N
61	http://fasb.org/us-types/2013-01-31	t	0	us-types	\N
62	http://www.xbrl.org/dtr/type/numeric	t	0	\N	\N
63	http://www.xbrl.org/2006/ref	t	0	\N	\N
64	http://fasb.org/us-roles/2013-01-31	t	0	us-roles	\N
65	http://www.xbrl.org/2003/instance	t	0	\N	\N
68	http://fasb.org/us-types/2011-01-31	t	0	us-types	\N
69	http://fasb.org/us-roles/2011-01-31	t	0	us-roles	\N
70	http://www.xbrl.org/2009/role/net	t	0	\N	\N
72	http://fasb.org/us-roles/2012-01-31	t	0	us-roles	\N
73	http://www.xbrl.org/2004/ref	t	0	\N	\N
74	http://xbrl.us/us-gaap/negated/2008-03-31	t	0	\N	\N
75	http://fasb.org/us-types/2012-01-31	t	0	us-types	\N
\.
*/
...
44	http://xbrl.sec.gov/invest/2012-01-31	t	8	invest	Investment
45	http://xbrl.sec.gov/country/2012-01-31	t	8	country	Country Listing
46	http://fasb.org/us-gaap/2013-01-31	t	9	us-gaap	US GAAP Core
47	http://xbrl.sec.gov/dei/2013-01-31	t	9	dei	Document Entity Information
48	http://xbrl.sec.gov/exch/2013-01-31	t	9	exch	Exchange Listing
49	http://xbrl.sec.gov/invest/2013-01-31	t	9	invest	Investment
50	http://xbrl.sec.gov/country/2013-01-31	t	9	country	Country Listing
51	http://fasb.org/us-gaap/2014-01-31	t	10	us-gaap	US GAAP Core
52	http://xbrl.sec.gov/dei/2014-01-31	t	10	dei	Document Entity Information
53	http://xbrl.sec.gov/exch/2014-01-31	t	10	exch	Exchange Listing
54	http://xbrl.sec.gov/currency/2014-01-31	t	10	currency	Currency Listing
55	http://fasb.org/us-gaap/2015-01-31	t	11	us-gaap	US GAAP Core
56	http://xbrl.sec.gov/exch/2015-01-31	t	11	exch	Exchange Listing
57	http://fasb.org/us-gaap/2016-01-31	t	12	us-gaap	US GAAP Core
58	http://xbrl.sec.gov/country/2016-01-31	t	12	country	Country Listing
59	http://xbrl.sec.gov/currency/2016-01-31	t	12	currency	Currency Listing
60	http://xbrl.sec.gov/exch/2016-01-31	t	12	exch	Exchange Listing
\.

--
-- Name: namespace_namespace_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('namespace_namespace_id_seq', 60, true);
...
SELECT pg_catalog.setval('sic_code_sic_code_id_seq', 444, true);
...
--
/*
COPY taxonomy_version (taxonomy_version_id, taxonomy_id, version, identifier_document_uri) FROM stdin;
4	2	2009	\N
5	3	2010	\N
6	3	2006	\N
7	4	2.1	\N
1	1	2008	http://xbrl.us/us-gaap/1.0/non-gaap/dei-2008-03-31.xsd
2	1	2009	http://taxonomies.xbrl.us/us-gaap/2009/non-gaap/dei-2009-01-31.xsd
3	1	2011	http://xbrl.sec.gov/dei/2011/dei-2011-01-31.xsd
8	1	2012	http://xbrl.sec.gov/dei/2012/dei-2012-01-31.xsd
9	1	2013	http://xbrl.sec.gov/dei/2013/dei-2013-01-31.xsd
10	1	2014	http://xbrl.sec.gov/dei/2014/dei-2014-01-31.xsd
\.
*/
...
--
-- Name: base_namespace_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--
...
ALTER TABLE ONLY context_dimension
	...
	--
-- Name: context_dimension_explicit_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--
...
ALTER TABLE ONLY label_resource
	...
	--
-- Name: pk_footnote_resouce; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--
...
CREATE INDEX context_dimension_explicit_index01
  ON context_dimension_explicit
  USING btree
  (context_id);


CREATE INDEX context_dimension_explicit_index02
  ON context_dimension_explicit
  USING btree
  (member_qname_id, dimension_qname_id);


CREATE INDEX context_dimension_explicit_index03
  ON context_dimension_explicit
  USING btree
  (dimension_qname_id, member_qname_id);


CREATE INDEX context_dimension_explicit_index04
  ON context_dimension_explicit
  USING btree
  (member_qname_id);


CREATE INDEX context_dimension_explicit_index05
  ON context_dimension_explicit
  USING btree
  (dimension_qname_id);


CREATE UNIQUE INDEX context_dimension_explicit_index06
  ON context_dimension_explicit
  USING btree
  (dimension_qname_id, context_id);
...
CREATE UNIQUE INDEX content_index04 ON context USING btree (fiscal_period, fiscal_year, context_id);

CREATE UNIQUE INDEX context_index05 ON context USING btree (fiscal_year, fiscal_period, context_id);

CREATE INDEX context_index06 ON context USING btree (fiscal_year, context_id);

CREATE INDEX context_index07 ON context USING btree (fiscal_period, context_id);
...
--
-- Name: fact_index10; Type: INDEX; Schema: public; Owner: postgres; Tablespace: 
--

CREATE INDEX fact_index10 ON fact USING btree (fact_hash);

--
-- Name: fact_index11; Type: INDEX; Schema: public; Owner: postgres; Tablespace: 
--

CREATE INDEX fact_index11 ON fact USING btree (calendar_hash);
...
CREATE UNIQUE INDEX reference_part_index01 ON reference_part USING btree (resource_id, qname_id);

CREATE UNIQUE INDEX reference_part_index02 ON reference_part USING btree (qname_id, resource_id);
...
--Table access control generated with:
/*
select '--
--ACCESS FOR TABLE ' || table_name || '
--
REVOKE ALL ON TABLE ' || table_name || ' FROM PUBLIC;
REVOKE ALL ON TABLE ' || table_name || ' FROM  postgres;
GRANT ALL ON TABLE ' || table_name || ' TO postgres;
GRANT ALL ON TABLE ' || table_name || ' TO edgar_db_write_all;'
...
GRANT ALL ON TABLE accession TO edgar_db_write_all;
--
--ACCESS FOR TABLE accession_document_association
--
REVOKE ALL ON TABLE accession_document_association FROM PUBLIC;
REVOKE ALL ON TABLE accession_document_association FROM  postgres;
GRANT ALL ON TABLE accession_document_association TO postgres;
GRANT ALL ON TABLE accession_document_association TO edgar_db_write_all;
--
--ACCESS FOR TABLE accession_element
--
REVOKE ALL ON TABLE accession_element FROM PUBLIC;
REVOKE ALL ON TABLE accession_element FROM  postgres;
GRANT ALL ON TABLE accession_element TO postgres;
GRANT ALL ON TABLE accession_element TO edgar_db_write_all;
--
--ACCESS FOR TABLE accession_timestamp
--
REVOKE ALL ON TABLE accession_timestamp FROM PUBLIC;
REVOKE ALL ON TABLE accession_timestamp FROM  postgres;
GRANT ALL ON TABLE accession_timestamp TO postgres;
GRANT ALL ON TABLE accession_timestamp TO edgar_db_write_all;
--
--ACCESS FOR TABLE attribute_value
--
REVOKE ALL ON TABLE attribute_value FROM PUBLIC;
REVOKE ALL ON TABLE attribute_value FROM  postgres;
GRANT ALL ON TABLE attribute_value TO postgres;
GRANT ALL ON TABLE attribute_value TO edgar_db_write_all;
--
--ACCESS FOR TABLE base_namespace
--
REVOKE ALL ON TABLE base_namespace FROM PUBLIC;
REVOKE ALL ON TABLE base_namespace FROM  postgres;
GRANT ALL ON TABLE base_namespace TO postgres;
GRANT ALL ON TABLE base_namespace TO edgar_db_write_all;
--
--ACCESS FOR TABLE config
--
REVOKE ALL ON TABLE config FROM PUBLIC;
REVOKE ALL ON TABLE config FROM  postgres;
GRANT ALL ON TABLE config TO postgres;
GRANT ALL ON TABLE config TO edgar_db_write_all;
--
--ACCESS FOR TABLE context
--
REVOKE ALL ON TABLE context FROM PUBLIC;
REVOKE ALL ON TABLE context FROM  postgres;
GRANT ALL ON TABLE context TO postgres;
GRANT ALL ON TABLE context TO edgar_db_write_all;
--
--ACCESS FOR TABLE context_aug
--
REVOKE ALL ON TABLE context_aug FROM PUBLIC;
REVOKE ALL ON TABLE context_aug FROM  postgres;
GRANT ALL ON TABLE context_aug TO postgres;
GRANT ALL ON TABLE context_aug TO edgar_db_write_all;
--
--ACCESS FOR TABLE context_dimension
--
REVOKE ALL ON TABLE context_dimension FROM PUBLIC;
REVOKE ALL ON TABLE context_dimension FROM  postgres;
GRANT ALL ON TABLE context_dimension TO postgres;
GRANT ALL ON TABLE context_dimension TO edgar_db_write_all;
--
--ACCESS FOR TABLE context_dimension_explicit
--
REVOKE ALL ON TABLE context_dimension_explicit FROM PUBLIC;
REVOKE ALL ON TABLE context_dimension_explicit FROM  postgres;
GRANT ALL ON TABLE context_dimension_explicit TO postgres;
GRANT ALL ON TABLE context_dimension_explicit TO edgar_db_write_all;
--
--ACCESS FOR TABLE custom_arcrole_type
--
REVOKE ALL ON TABLE custom_arcrole_type FROM PUBLIC;
REVOKE ALL ON TABLE custom_arcrole_type FROM  postgres;
GRANT ALL ON TABLE custom_arcrole_type TO postgres;
GRANT ALL ON TABLE custom_arcrole_type TO edgar_db_write_all;
--
--ACCESS FOR TABLE custom_arcrole_used_on
--
REVOKE ALL ON TABLE custom_arcrole_used_on FROM PUBLIC;
REVOKE ALL ON TABLE custom_arcrole_used_on FROM  postgres;
GRANT ALL ON TABLE custom_arcrole_used_on TO postgres;
GRANT ALL ON TABLE custom_arcrole_used_on TO edgar_db_write_all;
--
--ACCESS FOR TABLE custom_role_type
--
REVOKE ALL ON TABLE custom_role_type FROM PUBLIC;
REVOKE ALL ON TABLE custom_role_type FROM  postgres;
GRANT ALL ON TABLE custom_role_type TO postgres;
GRANT ALL ON TABLE custom_role_type TO edgar_db_write_all;
--
--ACCESS FOR TABLE custom_role_used_on
--
REVOKE ALL ON TABLE custom_role_used_on FROM PUBLIC;
REVOKE ALL ON TABLE custom_role_used_on FROM  postgres;
GRANT ALL ON TABLE custom_role_used_on TO postgres;
GRANT ALL ON TABLE custom_role_used_on TO edgar_db_write_all;
--
--ACCESS FOR TABLE document
--
...
GRANT ALL ON TABLE document TO edgar_db_write_all;
--
--ACCESS FOR TABLE element
--
REVOKE ALL ON TABLE element FROM PUBLIC;
REVOKE ALL ON TABLE element FROM  postgres;
GRANT ALL ON TABLE element TO postgres;
GRANT ALL ON TABLE element TO edgar_db_write_all;
--
--ACCESS FOR TABLE element_attribute
--
REVOKE ALL ON TABLE element_attribute FROM PUBLIC;
REVOKE ALL ON TABLE element_attribute FROM  postgres;
GRANT ALL ON TABLE element_attribute TO postgres;
GRANT ALL ON TABLE element_attribute TO edgar_db_write_all;
--
--ACCESS FOR TABLE element_attribute_value_association
--
REVOKE ALL ON TABLE element_attribute_value_association FROM PUBLIC;
REVOKE ALL ON TABLE element_attribute_value_association FROM  postgres;
GRANT ALL ON TABLE element_attribute_value_association TO postgres;
GRANT ALL ON TABLE element_attribute_value_association TO edgar_db_write_all;
--
--ACCESS FOR TABLE entity
--
REVOKE ALL ON TABLE entity FROM PUBLIC;
REVOKE ALL ON TABLE entity FROM  postgres;
GRANT ALL ON TABLE entity TO postgres;
GRANT ALL ON TABLE entity TO edgar_db_write_all;
--
--ACCESS FOR TABLE entity_name_history
--
REVOKE ALL ON TABLE entity_name_history FROM PUBLIC;
REVOKE ALL ON TABLE entity_name_history FROM  postgres;
GRANT ALL ON TABLE entity_name_history TO postgres;
GRANT ALL ON TABLE entity_name_history TO edgar_db_write_all;
--
--ACCESS FOR TABLE enumeration_arcrole_cycles_allowed
--
REVOKE ALL ON TABLE enumeration_arcrole_cycles_allowed FROM PUBLIC;
REVOKE ALL ON TABLE enumeration_arcrole_cycles_allowed FROM  postgres;
GRANT ALL ON TABLE enumeration_arcrole_cycles_allowed TO postgres;
GRANT ALL ON TABLE enumeration_arcrole_cycles_allowed TO edgar_db_write_all;
--
--ACCESS FOR TABLE enumeration_element_balance
--
REVOKE ALL ON TABLE enumeration_element_balance FROM PUBLIC;
REVOKE ALL ON TABLE enumeration_element_balance FROM  postgres;
GRANT ALL ON TABLE enumeration_element_balance TO postgres;
GRANT ALL ON TABLE enumeration_element_balance TO edgar_db_write_all;
--
--ACCESS FOR TABLE enumeration_element_period_type
--
REVOKE ALL ON TABLE enumeration_element_period_type FROM PUBLIC;
REVOKE ALL ON TABLE enumeration_element_period_type FROM  postgres;
GRANT ALL ON TABLE enumeration_element_period_type TO postgres;
GRANT ALL ON TABLE enumeration_element_period_type TO edgar_db_write_all;
--
--ACCESS FOR TABLE enumeration_unit_measure_location
--
REVOKE ALL ON TABLE enumeration_unit_measure_location FROM PUBLIC;
REVOKE ALL ON TABLE enumeration_unit_measure_location FROM  postgres;
GRANT ALL ON TABLE enumeration_unit_measure_location TO postgres;
GRANT ALL ON TABLE enumeration_unit_measure_location TO edgar_db_write_all;
--
--ACCESS FOR TABLE fact
--
REVOKE ALL ON TABLE fact FROM PUBLIC;
REVOKE ALL ON TABLE fact FROM  postgres;
GRANT ALL ON TABLE fact TO postgres;
GRANT ALL ON TABLE fact TO edgar_db_write_all;
--
--ACCESS FOR TABLE fact_aug
--
REVOKE ALL ON TABLE fact_aug FROM PUBLIC;
REVOKE ALL ON TABLE fact_aug FROM  postgres;
GRANT ALL ON TABLE fact_aug TO postgres;
GRANT ALL ON TABLE fact_aug TO edgar_db_write_all;
--
--ACCESS FOR TABLE industry
--
REVOKE ALL ON TABLE industry FROM PUBLIC;
REVOKE ALL ON TABLE industry FROM  postgres;
GRANT ALL ON TABLE industry TO postgres;
GRANT ALL ON TABLE industry TO edgar_db_write_all;
--
--ACCESS FOR TABLE industry_level
--
REVOKE ALL ON TABLE industry_level FROM PUBLIC;
REVOKE ALL ON TABLE industry_level FROM  postgres;
GRANT ALL ON TABLE industry_level TO postgres;
GRANT ALL ON TABLE industry_level TO edgar_db_write_all;
--
--ACCESS FOR TABLE industry_structure
--
REVOKE ALL ON TABLE industry_structure FROM PUBLIC;
REVOKE ALL ON TABLE industry_structure FROM  postgres;
GRANT ALL ON TABLE industry_structure TO postgres;
GRANT ALL ON TABLE industry_structure TO edgar_db_write_all;
--
--ACCESS FOR TABLE label_resource
--
REVOKE ALL ON TABLE label_resource FROM PUBLIC;
REVOKE ALL ON TABLE label_resource FROM  postgres;
GRANT ALL ON TABLE label_resource TO postgres;
GRANT ALL ON TABLE label_resource TO edgar_db_write_all;
--
--ACCESS FOR TABLE namespace
--
REVOKE ALL ON TABLE namespace FROM PUBLIC;
REVOKE ALL ON TABLE namespace FROM  postgres;
GRANT ALL ON TABLE namespace TO postgres;
GRANT ALL ON TABLE namespace TO edgar_db_write_all;
--
--ACCESS FOR TABLE network
--
REVOKE ALL ON TABLE network FROM PUBLIC;
REVOKE ALL ON TABLE network FROM  postgres;
GRANT ALL ON TABLE network TO postgres;
GRANT ALL ON TABLE network TO edgar_db_write_all;
--
--ACCESS FOR TABLE qname
--
REVOKE ALL ON TABLE qname FROM PUBLIC;
REVOKE ALL ON TABLE qname FROM  postgres;
GRANT ALL ON TABLE qname TO postgres;
GRANT ALL ON TABLE qname TO edgar_db_write_all;
--
--ACCESS FOR TABLE query_log
--
REVOKE ALL ON TABLE query_log FROM PUBLIC;
REVOKE ALL ON TABLE query_log FROM  postgres;
GRANT ALL ON TABLE query_log TO postgres;
GRANT ALL ON TABLE query_log TO edgar_db_write_all;
--
--ACCESS FOR TABLE reference_part
--
REVOKE ALL ON TABLE reference_part FROM PUBLIC;
REVOKE ALL ON TABLE reference_part FROM  postgres;
GRANT ALL ON TABLE reference_part TO postgres;
GRANT ALL ON TABLE reference_part TO edgar_db_write_all;
--
--ACCESS FOR TABLE relationship
--
...
GRANT ALL ON TABLE relationship TO edgar_db_write_all;
--
--ACCESS FOR TABLE resource
--
...
GRANT ALL ON TABLE resource TO edgar_db_write_all;
--
--ACCESS FOR TABLE sic_code
--
REVOKE ALL ON TABLE sic_code FROM PUBLIC;
REVOKE ALL ON TABLE sic_code FROM  postgres;
GRANT ALL ON TABLE sic_code TO postgres;
GRANT ALL ON TABLE sic_code TO edgar_db_write_all;
--
--ACCESS FOR TABLE taxonomy
--
...
GRANT ALL ON TABLE taxonomy TO edgar_db_write_all;
--
--ACCESS FOR TABLE taxonomy_version
--
REVOKE ALL ON TABLE taxonomy_version FROM PUBLIC;
REVOKE ALL ON TABLE taxonomy_version FROM  postgres;
GRANT ALL ON TABLE taxonomy_version TO postgres;
GRANT ALL ON TABLE taxonomy_version TO edgar_db_write_all;
--
--ACCESS FOR TABLE unit
--
REVOKE ALL ON TABLE unit FROM PUBLIC;
REVOKE ALL ON TABLE unit FROM  postgres;
GRANT ALL ON TABLE unit TO postgres;
GRANT ALL ON TABLE unit TO edgar_db_write_all;
--
--ACCESS FOR TABLE unit_measure
--
REVOKE ALL ON TABLE unit_measure FROM PUBLIC;
REVOKE ALL ON TABLE unit_measure FROM  postgres;
GRANT ALL ON TABLE unit_measure TO postgres;
GRANT ALL ON TABLE unit_measure TO edgar_db_write_all;
--
--ACCESS FOR TABLE uri
--
REVOKE ALL ON TABLE uri FROM PUBLIC;
REVOKE ALL ON TABLE uri FROM  postgres;
GRANT ALL ON TABLE uri TO postgres;
GRANT ALL ON TABLE uri TO edgar_db_write_all;

--Access control for sequences generated from:
/*
select '--
--ACCESS FOR SEQUENCE ' || sequence_name || '
--
REVOKE ALL ON SEQUENCE ' || sequence_name || ' FROM PUBLIC;
REVOKE ALL ON SEQUENCE ' || sequence_name || ' FROM  postgres;
GRANT ALL ON SEQUENCE ' || sequence_name || ' TO postgres;
GRANT ALL ON SEQUENCE ' || sequence_name || ' TO edgar_db_write_all;'
...
--
--ACCESS FOR SEQUENCE accession_accession_id_seq
--
...
GRANT ALL ON SEQUENCE accession_accession_id_seq TO edgar_db_write_all;
--
--ACCESS FOR SEQUENCE accession_document_associatio_accession_document_associatio_seq
--
REVOKE ALL ON SEQUENCE accession_document_associatio_accession_document_associatio_seq FROM PUBLIC;
REVOKE ALL ON SEQUENCE accession_document_associatio_accession_document_associatio_seq FROM  postgres;
GRANT ALL ON SEQUENCE accession_document_associatio_accession_document_associatio_seq TO postgres;
GRANT ALL ON SEQUENCE accession_document_associatio_accession_document_associatio_seq TO edgar_db_write_all;
--
--ACCESS FOR SEQUENCE accession_element_accession_element_id_seq
--
REVOKE ALL ON SEQUENCE accession_element_accession_element_id_seq FROM PUBLIC;
REVOKE ALL ON SEQUENCE accession_element_accession_element_id_seq FROM  postgres;
GRANT ALL ON SEQUENCE accession_element_accession_element_id_seq TO postgres;
GRANT ALL ON SEQUENCE accession_element_accession_element_id_seq TO edgar_db_write_all;
--
--ACCESS FOR SEQUENCE attribute_value_attribute_value_id_seq
--
REVOKE ALL ON SEQUENCE attribute_value_attribute_value_id_seq FROM PUBLIC;
REVOKE ALL ON SEQUENCE attribute_value_attribute_value_id_seq FROM  postgres;
GRANT ALL ON SEQUENCE attribute_value_attribute_value_id_seq TO postgres;
GRANT ALL ON SEQUENCE attribute_value_attribute_value_id_seq TO edgar_db_write_all;
--
--ACCESS FOR SEQUENCE base_namespace_base_namespace_id_seq
--
REVOKE ALL ON SEQUENCE base_namespace_base_namespace_id_seq FROM PUBLIC;
REVOKE ALL ON SEQUENCE base_namespace_base_namespace_id_seq FROM  postgres;
GRANT ALL ON SEQUENCE base_namespace_base_namespace_id_seq TO postgres;
GRANT ALL ON SEQUENCE base_namespace_base_namespace_id_seq TO edgar_db_write_all;
--
--ACCESS FOR SEQUENCE context_context_id_seq
--
REVOKE ALL ON SEQUENCE context_context_id_seq FROM PUBLIC;
REVOKE ALL ON SEQUENCE context_context_id_seq FROM  postgres;
GRANT ALL ON SEQUENCE context_context_id_seq TO postgres;
GRANT ALL ON SEQUENCE context_context_id_seq TO edgar_db_write_all;
--
--ACCESS FOR SEQUENCE context_dimension_context_dimension_id_seq
--
REVOKE ALL ON SEQUENCE context_dimension_context_dimension_id_seq FROM PUBLIC;
REVOKE ALL ON SEQUENCE context_dimension_context_dimension_id_seq FROM  postgres;
GRANT ALL ON SEQUENCE context_dimension_context_dimension_id_seq TO postgres;
GRANT ALL ON SEQUENCE context_dimension_context_dimension_id_seq TO edgar_db_write_all;
--
--ACCESS FOR SEQUENCE custom_arcrole_type_custom_arcrole_type_id_seq
--
REVOKE ALL ON SEQUENCE custom_arcrole_type_custom_arcrole_type_id_seq FROM PUBLIC;
REVOKE ALL ON SEQUENCE custom_arcrole_type_custom_arcrole_type_id_seq FROM  postgres;
GRANT ALL ON SEQUENCE custom_arcrole_type_custom_arcrole_type_id_seq TO postgres;
GRANT ALL ON SEQUENCE custom_arcrole_type_custom_arcrole_type_id_seq TO edgar_db_write_all;
--
--ACCESS FOR SEQUENCE custom_arcrole_used_on_custom_arcrole_used_on_id_seq
--
REVOKE ALL ON SEQUENCE custom_arcrole_used_on_custom_arcrole_used_on_id_seq FROM PUBLIC;
REVOKE ALL ON SEQUENCE custom_arcrole_used_on_custom_arcrole_used_on_id_seq FROM  postgres;
GRANT ALL ON SEQUENCE custom_arcrole_used_on_custom_arcrole_used_on_id_seq TO postgres;
GRANT ALL ON SEQUENCE custom_arcrole_used_on_custom_arcrole_used_on_id_seq TO edgar_db_write_all;
--
--ACCESS FOR SEQUENCE custom_role_type_custom_role_type_id_seq
--
REVOKE ALL ON SEQUENCE custom_role_type_custom_role_type_id_seq FROM PUBLIC;
REVOKE ALL ON SEQUENCE custom_role_type_custom_role_type_id_seq FROM  postgres;
GRANT ALL ON SEQUENCE custom_role_type_custom_role_type_id_seq TO postgres;
GRANT ALL ON SEQUENCE custom_role_type_custom_role_type_id_seq TO edgar_db_write_all;
--
--ACCESS FOR SEQUENCE custom_role_used_on_custom_role_used_on_id_seq
--
REVOKE ALL ON SEQUENCE custom_role_used_on_custom_role_used_on_id_seq FROM PUBLIC;
REVOKE ALL ON SEQUENCE custom_role_used_on_custom_role_used_on_id_seq FROM  postgres;
GRANT ALL ON SEQUENCE custom_role_used_on_custom_role_used_on_id_seq TO postgres;
GRANT ALL ON SEQUENCE custom_role_used_on_custom_role_used_on_id_seq TO edgar_db_write_all;
--
--ACCESS FOR SEQUENCE document_document_id_seq
--
REVOKE ALL ON SEQUENCE document_document_id_seq FROM PUBLIC;
REVOKE ALL ON SEQUENCE document_document_id_seq FROM  postgres;
GRANT ALL ON SEQUENCE document_document_id_seq TO postgres;
GRANT ALL ON SEQUENCE document_document_id_seq TO edgar_db_write_all;
--
--ACCESS FOR SEQUENCE element_attribute_element_attribute_id_seq
--
REVOKE ALL ON SEQUENCE element_attribute_element_attribute_id_seq FROM PUBLIC;
REVOKE ALL ON SEQUENCE element_attribute_element_attribute_id_seq FROM  postgres;
GRANT ALL ON SEQUENCE element_attribute_element_attribute_id_seq TO postgres;
GRANT ALL ON SEQUENCE element_attribute_element_attribute_id_seq TO edgar_db_write_all;
--
--ACCESS FOR SEQUENCE element_attribute_value_assoc_element_attribute_value_assoc_seq
--
REVOKE ALL ON SEQUENCE element_attribute_value_assoc_element_attribute_value_assoc_seq FROM PUBLIC;
REVOKE ALL ON SEQUENCE element_attribute_value_assoc_element_attribute_value_assoc_seq FROM  postgres;
GRANT ALL ON SEQUENCE element_attribute_value_assoc_element_attribute_value_assoc_seq TO postgres;
GRANT ALL ON SEQUENCE element_attribute_value_assoc_element_attribute_value_assoc_seq TO edgar_db_write_all;
--
--ACCESS FOR SEQUENCE element_element_id_seq
--
REVOKE ALL ON SEQUENCE element_element_id_seq FROM PUBLIC;
REVOKE ALL ON SEQUENCE element_element_id_seq FROM  postgres;
GRANT ALL ON SEQUENCE element_element_id_seq TO postgres;
GRANT ALL ON SEQUENCE element_element_id_seq TO edgar_db_write_all;
--
--ACCESS FOR SEQUENCE entity_entity_id_seq
--
REVOKE ALL ON SEQUENCE entity_entity_id_seq FROM PUBLIC;
REVOKE ALL ON SEQUENCE entity_entity_id_seq FROM  postgres;
GRANT ALL ON SEQUENCE entity_entity_id_seq TO postgres;
GRANT ALL ON SEQUENCE entity_entity_id_seq TO edgar_db_write_all;
--
--ACCESS FOR SEQUENCE entity_name_history_entity_name_history_id_seq
--
REVOKE ALL ON SEQUENCE entity_name_history_entity_name_history_id_seq FROM PUBLIC;
REVOKE ALL ON SEQUENCE entity_name_history_entity_name_history_id_seq FROM  postgres;
GRANT ALL ON SEQUENCE entity_name_history_entity_name_history_id_seq TO postgres;
GRANT ALL ON SEQUENCE entity_name_history_entity_name_history_id_seq TO edgar_db_write_all;
--
--ACCESS FOR SEQUENCE enumeration_arcrole_cycles_al_enumeration_arcrole_cycles_al_seq
--
REVOKE ALL ON SEQUENCE enumeration_arcrole_cycles_al_enumeration_arcrole_cycles_al_seq FROM PUBLIC;
REVOKE ALL ON SEQUENCE enumeration_arcrole_cycles_al_enumeration_arcrole_cycles_al_seq FROM  postgres;
GRANT ALL ON SEQUENCE enumeration_arcrole_cycles_al_enumeration_arcrole_cycles_al_seq TO postgres;
GRANT ALL ON SEQUENCE enumeration_arcrole_cycles_al_enumeration_arcrole_cycles_al_seq TO edgar_db_write_all;
--
--ACCESS FOR SEQUENCE enumeration_element_balance_enumeration_element_balance_id_seq
--
REVOKE ALL ON SEQUENCE enumeration_element_balance_enumeration_element_balance_id_seq FROM PUBLIC;
REVOKE ALL ON SEQUENCE enumeration_element_balance_enumeration_element_balance_id_seq FROM  postgres;
GRANT ALL ON SEQUENCE enumeration_element_balance_enumeration_element_balance_id_seq TO postgres;
GRANT ALL ON SEQUENCE enumeration_element_balance_enumeration_element_balance_id_seq TO edgar_db_write_all;
--
--ACCESS FOR SEQUENCE enumeration_element_period_ty_enumeration_element_period_ty_seq
--
REVOKE ALL ON SEQUENCE enumeration_element_period_ty_enumeration_element_period_ty_seq FROM PUBLIC;
REVOKE ALL ON SEQUENCE enumeration_element_period_ty_enumeration_element_period_ty_seq FROM  postgres;
GRANT ALL ON SEQUENCE enumeration_element_period_ty_enumeration_element_period_ty_seq TO postgres;
GRANT ALL ON SEQUENCE enumeration_element_period_ty_enumeration_element_period_ty_seq TO edgar_db_write_all;
--
--ACCESS FOR SEQUENCE enumeration_unit_measure_loca_enumeration_unit_measure_loca_seq
--
REVOKE ALL ON SEQUENCE enumeration_unit_measure_loca_enumeration_unit_measure_loca_seq FROM PUBLIC;
REVOKE ALL ON SEQUENCE enumeration_unit_measure_loca_enumeration_unit_measure_loca_seq FROM  postgres;
GRANT ALL ON SEQUENCE enumeration_unit_measure_loca_enumeration_unit_measure_loca_seq TO postgres;
GRANT ALL ON SEQUENCE enumeration_unit_measure_loca_enumeration_unit_measure_loca_seq TO edgar_db_write_all;
--
--ACCESS FOR SEQUENCE fact_fact_id_seq
--
REVOKE ALL ON SEQUENCE fact_fact_id_seq FROM PUBLIC;
REVOKE ALL ON SEQUENCE fact_fact_id_seq FROM  postgres;
GRANT ALL ON SEQUENCE fact_fact_id_seq TO postgres;
GRANT ALL ON SEQUENCE fact_fact_id_seq TO edgar_db_write_all;
--
--ACCESS FOR SEQUENCE industry_industry_id_seq
--
REVOKE ALL ON SEQUENCE industry_industry_id_seq FROM PUBLIC;
REVOKE ALL ON SEQUENCE industry_industry_id_seq FROM  postgres;
GRANT ALL ON SEQUENCE industry_industry_id_seq TO postgres;
GRANT ALL ON SEQUENCE industry_industry_id_seq TO edgar_db_write_all;
--
--ACCESS FOR SEQUENCE industry_level_industry_level_id_seq
--
REVOKE ALL ON SEQUENCE industry_level_industry_level_id_seq FROM PUBLIC;
REVOKE ALL ON SEQUENCE industry_level_industry_level_id_seq FROM  postgres;
GRANT ALL ON SEQUENCE industry_level_industry_level_id_seq TO postgres;
GRANT ALL ON SEQUENCE industry_level_industry_level_id_seq TO edgar_db_write_all;
--
--ACCESS FOR SEQUENCE industry_structure_industry_structure_id_seq
--
REVOKE ALL ON SEQUENCE industry_structure_industry_structure_id_seq FROM PUBLIC;
REVOKE ALL ON SEQUENCE industry_structure_industry_structure_id_seq FROM  postgres;
GRANT ALL ON SEQUENCE industry_structure_industry_structure_id_seq TO postgres;
GRANT ALL ON SEQUENCE industry_structure_industry_structure_id_seq TO edgar_db_write_all;
--
--ACCESS FOR SEQUENCE label_resource_resource_id_seq
--
REVOKE ALL ON SEQUENCE label_resource_resource_id_seq FROM PUBLIC;
REVOKE ALL ON SEQUENCE label_resource_resource_id_seq FROM  postgres;
GRANT ALL ON SEQUENCE label_resource_resource_id_seq TO postgres;
GRANT ALL ON SEQUENCE label_resource_resource_id_seq TO edgar_db_write_all;
--
--ACCESS FOR SEQUENCE namespace_namespace_id_seq
--
REVOKE ALL ON SEQUENCE namespace_namespace_id_seq FROM PUBLIC;
REVOKE ALL ON SEQUENCE namespace_namespace_id_seq FROM  postgres;
GRANT ALL ON SEQUENCE namespace_namespace_id_seq TO postgres;
GRANT ALL ON SEQUENCE namespace_namespace_id_seq TO edgar_db_write_all;
--
--ACCESS FOR SEQUENCE network_network_id_seq
--
REVOKE ALL ON SEQUENCE network_network_id_seq FROM PUBLIC;
REVOKE ALL ON SEQUENCE network_network_id_seq FROM  postgres;
GRANT ALL ON SEQUENCE network_network_id_seq TO postgres;
GRANT ALL ON SEQUENCE network_network_id_seq TO edgar_db_write_all;
--
--ACCESS FOR SEQUENCE qname_qname_id_seq
--
REVOKE ALL ON SEQUENCE qname_qname_id_seq FROM PUBLIC;
REVOKE ALL ON SEQUENCE qname_qname_id_seq FROM  postgres;
GRANT ALL ON SEQUENCE qname_qname_id_seq TO postgres;
GRANT ALL ON SEQUENCE qname_qname_id_seq TO edgar_db_write_all;
--
--ACCESS FOR SEQUENCE query_log_query_log_id_seq
--
REVOKE ALL ON SEQUENCE query_log_query_log_id_seq FROM PUBLIC;
REVOKE ALL ON SEQUENCE query_log_query_log_id_seq FROM  postgres;
GRANT ALL ON SEQUENCE query_log_query_log_id_seq TO postgres;
GRANT ALL ON SEQUENCE query_log_query_log_id_seq TO edgar_db_write_all;
--
--ACCESS FOR SEQUENCE reference_part_reference_part_id_seq
--
REVOKE ALL ON SEQUENCE reference_part_reference_part_id_seq FROM PUBLIC;
REVOKE ALL ON SEQUENCE reference_part_reference_part_id_seq FROM  postgres;
GRANT ALL ON SEQUENCE reference_part_reference_part_id_seq TO postgres;
GRANT ALL ON SEQUENCE reference_part_reference_part_id_seq TO edgar_db_write_all;
--
--ACCESS FOR SEQUENCE relationship_relationship_id_seq
--
REVOKE ALL ON SEQUENCE relationship_relationship_id_seq FROM PUBLIC;
REVOKE ALL ON SEQUENCE relationship_relationship_id_seq FROM  postgres;
GRANT ALL ON SEQUENCE relationship_relationship_id_seq TO postgres;
GRANT ALL ON SEQUENCE relationship_relationship_id_seq TO edgar_db_write_all;
--
--ACCESS FOR SEQUENCE resource_resource_id_seq
--
REVOKE ALL ON SEQUENCE resource_resource_id_seq FROM PUBLIC;
REVOKE ALL ON SEQUENCE resource_resource_id_seq FROM  postgres;
GRANT ALL ON SEQUENCE resource_resource_id_seq TO postgres;
GRANT ALL ON SEQUENCE resource_resource_id_seq TO edgar_db_write_all;
--
--ACCESS FOR SEQUENCE sic_code_sic_code_id_seq
--
REVOKE ALL ON SEQUENCE sic_code_sic_code_id_seq FROM PUBLIC;
REVOKE ALL ON SEQUENCE sic_code_sic_code_id_seq FROM  postgres;
GRANT ALL ON SEQUENCE sic_code_sic_code_id_seq TO postgres;
GRANT ALL ON SEQUENCE sic_code_sic_code_id_seq TO edgar_db_write_all;
--
--ACCESS FOR SEQUENCE taxonomy_taxonomy_id_seq
--
REVOKE ALL ON SEQUENCE taxonomy_taxonomy_id_seq FROM PUBLIC;
REVOKE ALL ON SEQUENCE taxonomy_taxonomy_id_seq FROM  postgres;
GRANT ALL ON SEQUENCE taxonomy_taxonomy_id_seq TO postgres;
GRANT ALL ON SEQUENCE taxonomy_taxonomy_id_seq TO edgar_db_write_all;
--
--ACCESS FOR SEQUENCE taxonomy_version_taxonomy_version_id_seq
--
REVOKE ALL ON SEQUENCE taxonomy_version_taxonomy_version_id_seq FROM PUBLIC;
REVOKE ALL ON SEQUENCE taxonomy_version_taxonomy_version_id_seq FROM  postgres;
GRANT ALL ON SEQUENCE taxonomy_version_taxonomy_version_id_seq TO postgres;
GRANT ALL ON SEQUENCE taxonomy_version_taxonomy_version_id_seq TO edgar_db_write_all;
--
--ACCESS FOR SEQUENCE unit_measure_unit_measure_id_seq
--
REVOKE ALL ON SEQUENCE unit_measure_unit_measure_id_seq FROM PUBLIC;
REVOKE ALL ON SEQUENCE unit_measure_unit_measure_id_seq FROM  postgres;
GRANT ALL ON SEQUENCE unit_measure_unit_measure_id_seq TO postgres;
GRANT ALL ON SEQUENCE unit_measure_unit_measure_id_seq TO edgar_db_write_all;
--
--ACCESS FOR SEQUENCE unit_unit_id_seq
--
...
GRANT ALL ON SEQUENCE unit_unit_id_seq TO edgar_db_write_all;
--
--ACCESS FOR SEQUENCE uri_uri_id_seq
--
REVOKE ALL ON SEQUENCE uri_uri_id_seq FROM PUBLIC;
REVOKE ALL ON SEQUENCE uri_uri_id_seq FROM  postgres;
GRANT ALL ON SEQUENCE uri_uri_id_seq TO postgres;
GRANT ALL ON SEQUENCE uri_uri_id_seq TO edgar_db_write_all;
